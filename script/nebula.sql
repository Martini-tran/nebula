...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI 智能体定义表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_agent
-- ----------------------------
INSERT INTO `ai_agent` VALUES (1, 'weather_query', '天气查询', NULL, 'weather_query', 1, NULL, NULL, NULL, NULL, 1, 1, '2026-07-07 13:35:38', '2026-07-07 13:35:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI 智能体执行实例（状态机）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI 智能体状态转移历史（回放/审计），每次 attempt 落一行' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI 智能体跨实例迭代链（系列递推）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ai_agent_iteration
-- ----------------------------
INSERT INTO `ai_agent_iteration` VALUES (1, 'blog_series_writer-chain-demo01', '30天Java进阶', 'blog_series_writer', '0 0 9 * * ?', '2026-07-09 09:00:00', 6, 30, 'getString(\'outlineDone\') == \'true\'', '{\"outline\":\"outline\",\"accumulated\":\"accumulated\",\"articleTitle\":\"history\",\"prevSeq\":\"prevSeq\"}', '{\"topic\":\"30天Java进阶\"}', 'blog_series_writer-a8729d85f80246579e6538ce2055286a', NULL, NULL, 'ACTIVE', 0, NULL, 6, 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', '2026-07-08 19:21:03', '2026-07-08 19:31:43');
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI流程边表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI流程节点表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '编排回调投递记录（日志 + 断点续发）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ai_webhook_delivery
-- ----------------------------
INSERT INTO `ai_webhook_delivery` VALUES (1, 'blog_series_writer-chain-demo01-1', 'blog_series_writer-fd20c302260243eb9195993e13653421', 'blog_series_writer-chain-demo01', 1, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-1\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":1,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-fd20c302260243eb9195993e13653421\",\"context\":{\"updatedOutline\":{\"title\":\"《30天Java进阶》\",\"parts\":[{\"partTitle\":\"基础进阶\",\"articles\":[\"第1篇：Java基础回顾与开发环境搭建\",\"第2篇：面向对象深入——封装、继承、多态\",\"第3篇：集合框架精讲——List、Set、Map\",\"第4篇：泛型与类型安全\",\"第5篇：枚举与注解——代码的元数据\",\"第6篇：Java异常处理与日志记录\"]},{\"partTitle\":\"核心API\",\"articles\":[\"第7篇：I/O流与文件操作\",\"第8篇：多线程基础与线程安全\",\"第9篇：并发工具类与锁机制\",\"第10篇：网络编程与Socket通信\"]},{\"partTitle\":\"高级特性\",\"articles\":[\"第11篇：反射与动态代理\",\"第12篇：函数式编程与Lambda表达式\",\"第13篇：Stream API详解\",\"第14篇：Optional与函数式接口\"]},{\"partTitle\":\"实战应用\",\"articles\":[\"第15篇：JDBC与数据库操作\",\"第16篇：单元测试与Mockito\",\"第17篇：构建工具Maven/Gradle\",\"第18篇：设计模式实战（工厂、单例、观察者）\",\"第19篇：Java模块化系统（JPMS）\",\"第20篇：性能调优与JVM基础\"]},{\"partTitle\":\"项目实战\",\"articles\":[\"第21篇：命令行工具开发\",\"第22篇：简易Web服务器\",\"第23篇：REST API设计与实现\",\"第24篇：文件搜索引擎\",\"第25篇：聊天室应用\"]},{\"partTitle\":\"扩展与生态\",\"articles\":[\"第26篇：Spring Boot入门\",\"第27篇：MyBatis持久层框架\",\"第28篇：Redis缓存集成\",\"第29篇：Docker容器化部署\",\"第30篇：总结与下一步学习路线\"]}]},\"topic\":\"30天Java进阶\",\"article\":{\"title\":\"第6篇：Java异常处理与日志记录——从错误中优雅恢复\",\"content\":\"在前几篇文章中，我们深入探讨了Java的面向对象特性、集合框架和泛型。但程序并非总是完美运行，异常和错误是开发中不可避免的一部分。今天，我们将聚焦于Java的异常处理机制和日志记录，学习如何编写健壮的代码，从错误中优雅恢复。\\n\\n## 1. Java异常体系\\n\\nJava异常体系基于Throwable类，主要分为两大类：\\n- **Error**：表示严重错误，如OutOfMemoryError，通常不可恢复。\\n- **Exception**：表示程序可处理的异常，又分为：\\n  - **Checked Exception**：编译时检查，如IOException，必须处理。\\n  - **Unchecked Exception**：运行时异常，如NullPointerException，可选处理。\\n\\n### 示例：异常继承树\\n```java\\nThrowable\\n├── Error\\n│   ├── OutOfMemoryError\\n│   └── StackOverflowError\\n└── Exception\\n    ├── IOException (Checked)\\n    ├── SQLException (Checked)\\n    └── RuntimeException (Unchecked)\\n        ├── NullPointerException\\n        └── ArithmeticException\\n```\\n\\n## 2. 异常处理机制\\n\\n### 2.1 try-catch-finally\\n```java\\ntry {\\n    int result = 10 / 0; // 可能抛出ArithmeticException\\n} catch (ArithmeticException e) {\\n    System.out.println(\\\"除数不能为零：\\\" + e.getMessage());\\n} finally {\\n    System.out.println(\\\"无论是否异常都会执行\\\");\\n}\\n```\\n- **try**：包裹可能抛出异常的代码。\\n- **catch**：捕获并处理特定异常，可多个catch块按顺序匹配。\\n- **finally**：可选，用于释放资源（如关闭文件），即使return也会执行。\\n\\n### 2.2 多重捕获与异常链\\n```java\\ntry {\\n    // 可能抛出多种异常\\n} catch (IOException | SQLException e) {\\n    // Java 7+ 支持多重捕获\\n    e.printStackTrace();\\n} catch (Exception e) {\\n    // 异常链：将原始异常包装为新异常\\n    throw new RuntimeException(\\\"业务异常\\\", e);\\n}\\n```\\n\\n### 2.3 try-with-resources (Java 7+)\\n自动关闭实现了AutoCloseable的资源：\\n```java\\ntry (BufferedReader br = new BufferedReader(new FileReader(\\\"test.txt\\\"))) {\\n    System.out.println(br.readLine());\\n} catch (IOException e) {\\n    e.printStackTrace();\\n}\\n// br自动关闭，无需finally\\n```\\n\\n## 3. 自定义异常\\n创建业务相关的异常类：\\n```java\\npublic class InsufficientBalanceException extends Exception {\\n    private double balance;\\n    private double amount;\\n\\n    public InsufficientBalanceException(double balance, double amount) {\\n        super(String.format(\\\"余额不足：当前%.2f，需要%.2f\\\", balance, amount));\\n        this.balance = balance;\\n        this.amount = amount;\\n    }\\n    // getter方法\\n}\\n\\n// 使用\\npublic void withdraw(double amount) throws InsufficientBalanceException {\\n    if (amount > balance) {\\n        throw new InsufficientBalanceException(balance, amount);\\n    }\\n    balance -= amount;\\n}\\n```\\n\\n## 4. 日志记录：SLF4J与Logback\\n异常处理离不开日志记录。推荐使用SLF4J作为门面，Logback作为实现。\\n\\n### 4.1 添加依赖（Maven）\\n```xml\\n<dependency>\\n    <groupId>org.slf4j</groupId>\\n    <artifactId>slf4j-api</artifactId>\\n    <version>1.7.36</version>\\n</dependency>\\n<dependency>\\n    <groupId>ch.qos.logback</groupId>\\n    <artifactId>logback-classic</artifactId>\\n    <version>1.2.11</version>\\n</dependency>\\n```\\n\\n### 4.2 使用示例\\n```java\\nimport org.slf4j.Logger;\\nimport org.slf4j.LoggerFactory;\\n\\npublic class BankService {\\n    private static final Logger logger = LoggerFactory.getLogger(BankService.class);\\n\\n    public void withdraw(double amount) {\\n        try {\\n            if (amount > balance) {\\n                throw new InsufficientBalanceException(balance, amount);\\n            }\\n            balance -= amount;\\n            logger.info(\\\"取款成功：金额={}，余额={}\\\", amount, balance);\\n        } catch (InsufficientBalanceException e) {\\n            logger.error(\\\"取款失败：{}\\\", e.getMessage(), e);\\n        }\\n    }\\n}\\n```\\n\\n### 4.3 日志级别\\n- **ERROR**：严重错误，需要立即关注。\\n- **WARN**：潜在问题，但不影响运行。\\n- **INFO**：重要运行信息。\\n- **DEBUG**：调试信息，开发阶段使用。\\n- **TRACE**：更详细的跟踪信息。\\n\\n## 5. 最佳实践\\n\\n1. **不要捕获Exception基类**：应捕获具体异常，避免隐藏问题。\\n2. **不要忽略异常**：空catch块是反模式，至少记录日志。\\n3. **尽早抛出，延迟捕获**：在错误发生处立即抛出，在合适层级处理。\\n4. **使用日志替代System.out**：日志可配置级别、输出位置，便于生产排查。\\n5. **资源管理优先用try-with-resources**：避免资源泄漏。\\n\\n## 6. 实战：银行账户系统\\n```java\\npublic class Account {\\n    private static final Logger logger = LoggerFactory.getLogger(Account.class);\\n    private double balance;\\n\\n    public void transfer(Account target, double amount) throws InsufficientBalanceException {\\n        if (amount <= 0) {\\n            throw new IllegalArgumentException(\\\"转账金额必须为正数\\\");\\n        }\\n        if (this.balance < amount) {\\n            throw new InsufficientBalanceException(this.balance, amount);\\n        }\\n        this.balance -= amount;\\n        target.balance += amount;\\n        logger.info(\\\"转账成功：从{}向{}转账{}元\\\", this, target, amount);\\n    }\\n\\n    public static void main(String[] args) {\\n        Account a = new Account(1000);\\n        Account b = new Account(500);\\n        try {\\n            a.transfer(b, 200);\\n        } catch (InsufficientBalanceException e) {\\n            logger.error(\\\"转账失败：{}\\\", e.getMessage());\\n        } catch (IllegalArgumentException e) {\\n            logger.warn(\\\"参数错误：{}\\\", e.getMessage());\\n        }\\n    }\\n}\\n```\\n\\n## 总结\\n本文介绍了Java异常体系、处理机制、自定义异常以及日志记录。通过合理使用异常和日志，你可以编写更健壮、可维护的代码。下一篇文章，我们将探讨Java的I/O流与文件操作，敬请期待！\",\"seq\":6,\"prevSeq\":5,\"nextSeq\":7},\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"isComplete\":false,\"seriesState\":\"{\\n  \\\"article\\\": {\\n    \\\"title\\\": \\\"第6篇：Java异常处理与日志记录——从错误中优雅恢复\\\",\\n    \\\"content\\\": \\\"在前几篇文章中，我们深入探讨了Java的面向对象特性、集合框架和泛型。但程序并非总是完美运行，异常和错误是开发中不可避免的一部分。今天，我们将聚焦于Java的异常处理机制和日志记录，学习如何编写健壮的代码，从错误中优雅恢复。\\\\n\\\\n## 1. Java异常体系\\\\n\\\\nJava异常体系基于Throwable类，主要分为两大类：\\\\n- **Error**：表示严重错误，如OutOfMemoryError，通常不可恢复。\\\\n- **Exception**：表示程序可处理的异常，又分为：\\\\n  - **Checked Exception**：编译时检查，如IOException，必须处理。\\\\n  - **Unchecked Exception**：运行时异常，如NullPointerException，可选处理。\\\\n\\\\n### 示例：异常继承树\\\\n```java\\\\nThrowable\\\\n├── Error\\\\n│   ├── OutOfMemoryError\\\\n│   └── StackOverflowError\\\\n└── Exception\\\\n    ├── IOException (Checked)\\\\n    ├── SQLException (Checked)\\\\n    └── RuntimeException (Unchecked)\\\\n        ├── NullPointerException\\\\n        └── ArithmeticException\\\\n```\\\\n\\\\n## 2. 异常处理机制\\\\n\\\\n### 2.1 try-catch-finally\\\\n```java\\\\ntry {\\\\n    int result = 10 / 0; // 可能抛出ArithmeticException\\\\n} catch (ArithmeticException e) {\\\\n    System.out.println(\\\\\\\"除数不能为零：\\\\\\\" + e.getMessage());\\\\n} finally {\\\\n    System.out.println(\\\\\\\"无论是否异常都会执行\\\\\\\");\\\\n}\\\\n```\\\\n- **try**：包裹可能抛出异常的代码。\\\\n- **catch**：捕获并处理特定异常，可多个catch块按顺序匹配。\\\\n- **finally**：可选，用于释放资源（如关闭文件），即使return也会执行。\\\\n\\\\n### 2.2 多重捕获与异常链\\\\n```java\\\\ntry {\\\\n    // 可能抛出多种异常\\\\n} catch (IOException | SQLException e) {\\\\n    // Java 7+ 支持多重捕获\\\\n    e.printStackTrace();\\\\n} catch (Exception e) {\\\\n    // 异常链：将原始异常包装为新异常\\\\n    throw new RuntimeException(\\\\\\\"业务异常\\\\\\\", e);\\\\n}\\\\n```\\\\n\\\\n### 2.3 try-with-resources (Java 7+)\\\\n自动关闭实现了AutoCloseable的资源：\\\\n```java\\\\ntry (BufferedReader br = new BufferedReader(new FileReader(\\\\\\\"test.txt\\\\\\\"))) {\\\\n    System.out.println(br.readLine());\\\\n} catch (IOException e) {\\\\n    e.printStackTrace();\\\\n}\\\\n// br自动关闭，无需finally\\\\n```\\\\n\\\\n## 3. 自定义异常\\\\n创建业务相关的异常类：\\\\n```java\\\\npublic class InsufficientBalanceException extends Exception {\\\\n    private double balance;\\\\n    private double amount;\\\\n\\\\n    public InsufficientBalanceException(double balance, double amount) {\\\\n        super(String.format(\\\\\\\"余额不足：当前%.2f，需要%.2f\\\\\\\", balance, amount));\\\\n        this.balance = balance;\\\\n        this.amount = amount;\\\\n    }\\\\n    // getter方法\\\\n}\\\\n\\\\n// 使用\\\\npublic void withdraw(double amount) throws InsufficientBalanceException {\\\\n    if (amount > balance) {\\\\n        throw new InsufficientBalanceException(balance, amount);\\\\n    }\\\\n    balance -= amount;\\\\n}\\\\n```\\\\n\\\\n## 4. 日志记录：SLF4J与Logback\\\\n异常处理离不开日志记录。推荐使用SLF4J作为门面，Logback作为实现。\\\\n\\\\n### 4.1 添加依赖（Maven）\\\\n```xml\\\\n<dependency>\\\\n    <groupId>org.slf4j</groupId>\\\\n    <artifactId>slf4j-api</artifactId>\\\\n    <version>1.7.36</version>\\\\n</dependency>\\\\n<dependency>\\\\n    <groupId>ch.qos.logback</groupId>\\\\n    <artifactId>logback-classic</artifactId>\\\\n    <version>1.2.11</version>\\\\n</dependency>\\\\n```\\\\n\\\\n### 4.2 使用示例\\\\n```java\\\\nimport org.slf4j.Logger;\\\\nimport org.slf4j.LoggerFactory;\\\\n\\\\npublic class BankService {\\\\n    private static final Logger logger = LoggerFactory.getLogger(BankService.class);\\\\n\\\\n    public void withdraw(double amount) {\\\\n        try {\\\\n            if (amount > balance) {\\\\n                throw new InsufficientBalanceException(balance, amount);\\\\n            }\\\\n            balance -= amount;\\\\n            logger.info(\\\\\\\"取款成功：金额={}，余额={}\\\\\\\", amount, balance);\\\\n        } catch (InsufficientBalanceException e) {\\\\n            logger.error(\\\\\\\"取款失败：{}\\\\\\\", e.getMessage(), e);\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n### 4.3 日志级别\\\\n- **ERROR**：严重错误，需要立即关注。\\\\n- **WARN**：潜在问题，但不影响运行。\\\\n- **INFO**：重要运行信息。\\\\n- **DEBUG**：调试信息，开发阶段使用。\\\\n- **TRACE**：更详细的跟踪信息。\\\\n\\\\n## 5. 最佳实践\\\\n\\\\n1. **不要捕获Exception基类**：应捕获具体异常，避免隐藏问题。\\\\n2. **不要忽略异常**：空catch块是反模式，至少记录日志。\\\\n3. **尽早抛出，延迟捕获**：在错误发生处立即抛出，在合适层级处理。\\\\n4. **使用日志替代System.out**：日志可配置级别、输出位置，便于生产排查。\\\\n5. **资源管理优先用try-with-resources**：避免资源泄漏。\\\\n\\\\n## 6. 实战：银行账户系统\\\\n```java\\\\npublic class Account {\\\\n    private static final Logger logger = LoggerFactory.getLogger(Account.class);\\\\n    private double balance;\\\\n\\\\n    public void transfer(Account target, double amount) throws InsufficientBalanceException {\\\\n        if (amount <= 0) {\\\\n            throw new IllegalArgumentException(\\\\\\\"转账金额必须为正数\\\\\\\");\\\\n        }\\\\n        if (this.balance < amount) {\\\\n            throw new InsufficientBalanceException(this.balance, amount);\\\\n        }\\\\n        this.balance -= amount;\\\\n        target.balance += amount;\\\\n        logger.info(\\\\\\\"转账成功：从{}向{}转账{}元\\\\\\\", this, target, amount);\\\\n    }\\\\n\\\\n    public static void main(String[] args) {\\\\n        Account a = new Account(1000);\\\\n        Account b = new Account(500);\\\\n        try {\\\\n            a.transfer(b, 200);\\\\n        } catch (InsufficientBalanceException e) {\\\\n            logger.error(\\\\\\\"转账失败：{}\\\\\\\", e.getMessage());\\\\n        } catch (IllegalArgumentException e) {\\\\n            logger.warn(\\\\\\\"参数错误：{}\\\\\\\", e.getMessage());\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 总结\\\\n本文介绍了Java异常体系、处理机制、自定义异常以及日志记录。通过合理使用异常和日志，你可以编写更健壮、可维护的代码。下一篇文章，我们将探讨Java的I/O流与文件操作，敬请期待！\\\",\\n    \\\"seq\\\": 6,\\n    \\\"prevSeq\\\": 5,\\n    \\\"nextSeq\\\": 7\\n  },\\n  \\\"updatedOutline\\\": {\\n    \\\"title\\\": \\\"《30天Java进阶》\\\",\\n    \\\"parts\\\": [\\n      {\\n        \\\"partTitle\\\": \\\"基础进阶\\\",\\n        \\\"articles\\\": [\\n          \\\"第1篇：Java基础回顾与开发环境搭建\\\",\\n          \\\"第2篇：面向对象深入——封装、继承、多态\\\",\\n          \\\"第3篇：集合框架精讲——List、Set、Map\\\",\\n          \\\"第4篇：泛型与类型安全\\\",\\n          \\\"第5篇：枚举与注解——代码的元数据\\\",\\n          \\\"第6篇：Java异常处理与日志记录\\\"\\n        ]\\n      },\\n      {\\n        \\\"partTitle\\\": \\\"核心API\\\",\\n        \\\"articles\\\": [\\n          \\\"第7篇：I/O流与文件操作\\\",\\n          \\\"第8篇：多线程基础与线程安全\\\",\\n          \\\"第9篇：并发工具类与锁机制\\\",\\n          \\\"第10篇：网络编程与Socket通信\\\"\\n        ]\\n      },\\n      {\\n        \\\"partTitle\\\": \\\"高级特性\\\",\\n        \\\"articles\\\": [\\n          \\\"第11篇：反射与动态代理\\\",\\n          \\\"第12篇：函数式编程与Lambda表达式\\\",\\n          \\\"第13篇：Stream API详解\\\",\\n          \\\"第14篇：Optional与函数式接口\\\"\\n        ]\\n      },\\n      {\\n        \\\"partTitle\\\": \\\"实战应用\\\",\\n        \\\"articles\\\": [\\n          \\\"第15篇：JDBC与数据库操作\\\",\\n          \\\"第16篇：单元测试与Mockito\\\",\\n          \\\"第17篇：构建工具Maven/Gradle\\\",\\n          \\\"第18篇：设计模式实战（工厂、单例、观察者）\\\",\\n          \\\"第19篇：Java模块化系统（JPMS）\\\",\\n          \\\"第20篇：性能调优与JVM基础\\\"\\n        ]\\n      },\\n      {\\n        \\\"partTitle\\\": \\\"项目实战\\\",\\n        \\\"articles\\\": [\\n          \\\"第21篇：命令行工具开发\\\",\\n          \\\"第22篇：简易Web服务器\\\",\\n          \\\"第23篇：REST API设计与实现\\\",\\n          \\\"第24篇：文件搜索引擎\\\",\\n          \\\"第25篇：聊天室应用\\\"\\n        ]\\n      },\\n      {\\n        \\\"partTitle\\\": \\\"扩展与生态\\\",\\n        \\\"articles\\\": [\\n          \\\"第26篇：Spring Boot入门\\\",\\n          \\\"第27篇：MyBatis持久层框架\\\",\\n          \\\"第28篇：Redis缓存集成\\\",\\n          \\\"第29篇：Docker容器化部署\\\",\\n          \\\"第30篇：总结与下一步学习路线\\\"\\n        ]\\n      }\\n    ]\\n  },\\n  \\\"accumulated\\\": {\\n    \\\"usedExamples\\\": [\\n      \\\"银行账户系统（异常处理）\\\",\\n      \\\"文件读取（try-with-resources）\\\",\\n      \\\"自定义异常类\\\"\\n    ],\\n    \\\"coveredTopics\\\": [\\n      \\\"异常体系\\\",\\n      \\\"try-catch-finally\\\",\\n      \\\"多重捕获\\\",\\n      \\\"try-with-resources\\\",\\n      \\\"自定义异常\\\",\\n      \\\"SLF4J与Logback日志\\\",\\n      \\\"日志级别\\\",\\n      \\\"最佳实践\\\"\\n    ],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\\\"\\n  },\\n  \\\"isComplete\\\": false\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 3, 8, NULL, 'Connect to http://127.0.0.1:8080 failed: Connection refused: getsockopt', '2026-07-08 19:38:28', '2026-07-08 19:21:51', '2026-07-08 19:36:13');
INSERT INTO `ai_webhook_delivery` VALUES (2, 'blog_series_writer-chain-demo01-2', 'blog_series_writer-75ae463fbbc743fcb6277196748434c3', 'blog_series_writer-chain-demo01', 2, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-2\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":2,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-75ae463fbbc743fcb6277196748434c3\",\"context\":{\"prevSeq\":1,\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\",\"集合框架概述\",\"List接口与ArrayList/LinkedList\",\"Set接口与HashSet/TreeSet\",\"Map接口与HashMap/TreeMap\",\"泛型\",\"迭代器与增强for循环\",\"集合最佳实践\"],\"article\":{\"title\":\"第2篇：集合框架——从数组到泛型集合的进化\",\"content\":\"在上一篇中，我们深入探讨了Java的异常处理与日志记录，确保你的银行账户系统能优雅地处理错误。今天，我们将转向另一个核心话题：集合框架。想象一下，你的银行系统需要管理成千上万的客户账户——数组固然简单，但它的固定长度和缺乏灵活性会让你头疼不已。Java的集合框架（Collections Framework）正是为此而生，它提供了动态、高效的数据结构。\\n\\n## 从数组到集合的痛点\\n\\n数组是Java中最基础的数据结构，但它的局限性很明显：\\n- 长度固定：一旦创建，无法动态增长。\\n- 类型单一：只能存储同一种类型。\\n- 操作繁琐：增删元素需要手动移动数据。\\n\\n例如，在银行系统中，我们可能需要记录客户的交易历史。使用数组：\\n```java\\nString[] transactions = new String[100]; // 假设最多100条\\nint count = 0;\\ntransactions[count++] = \\\"存款1000元\\\";\\ntransactions[count++] = \\\"取款500元\\\";\\n// 如果超过100条，必须新建数组并复制数据\\n```\\n\\n这显然不够灵活。集合框架的出现，让我们能用更少的代码实现动态管理。\\n\\n## 集合框架的三大核心接口\\n\\nJava集合框架以接口为核心，主要分为三大类：\\n1. **List**：有序、可重复的集合（类似动态数组）。\\n2. **Set**：无序、不可重复的集合（类似数学中的集合）。\\n3. **Map**：键值对映射，键不可重复。\\n\\n### 泛型：让集合更安全\\n\\n在Java 5之前，集合默认存储Object类型，需要强制类型转换，容易引发ClassCastException。泛型（Generics）的出现解决了这个问题：\\n```java\\n// 没有泛型（旧式）\\nList accounts = new ArrayList();\\naccounts.add(\\\"张三\\\"); // 自动向上转型为Object\\nString name = (String) accounts.get(0); // 必须强制转换\\n\\n// 使用泛型（推荐）\\nList<String> accounts = new ArrayList<>();\\naccounts.add(\\\"张三\\\");\\nString name = accounts.get(0); // 无需转换，类型安全\\n```\\n\\n在银行系统中，我们可以用泛型集合管理账户：\\n```java\\npublic class Bank {\\n    private List<Account> accounts = new ArrayList<>();\\n    \\n    public void addAccount(Account account) {\\n        accounts.add(account);\\n    }\\n    \\n    public Account findAccount(String accountNumber) {\\n        for (Account acc : accounts) {\\n            if (acc.getAccountNumber().equals(accountNumber)) {\\n                return acc;\\n            }\\n        }\\n        return null;\\n    }\\n}\\n```\\n\\n## 常用实现类详解\\n\\n### ArrayList vs LinkedList\\n- **ArrayList**：基于动态数组，随机访问快（O(1)），但插入删除慢（O(n)）。\\n- **LinkedList**：基于双向链表，插入删除快（O(1)），但随机访问慢（O(n)）。\\n\\n示例：记录交易日志，如果频繁追加，ArrayList更合适；如果频繁在头部插入，LinkedList更优。\\n\\n### HashSet vs TreeSet\\n- **HashSet**：基于哈希表，无序，查找快（O(1)）。\\n- **TreeSet**：基于红黑树，自动排序，查找稍慢（O(log n)）。\\n\\n在银行系统中，如果我们需要按账户余额排序，可以用TreeSet：\\n```java\\nSet<Account> sortedAccounts = new TreeSet<>((a1, a2) -> \\n    Double.compare(a1.getBalance(), a2.getBalance()));\\n```\\n\\n### HashMap vs TreeMap\\n- **HashMap**：基于哈希表，键无序，查找快（O(1)）。\\n- **TreeMap**：基于红黑树，键自动排序。\\n\\n例如，用Map存储客户ID与账户的映射：\\n```java\\nMap<String, Account> accountMap = new HashMap<>();\\naccountMap.put(\\\"C001\\\", new Account(\\\"张三\\\", 1000));\\nAccount acc = accountMap.get(\\\"C001\\\"); // 快速查找\\n```\\n\\n## 迭代器与增强for循环\\n\\n遍历集合时，增强for循环（for-each）更简洁：\\n```java\\nfor (Account acc : accounts) {\\n    System.out.println(acc.getOwner());\\n}\\n```\\n\\n但需要删除元素时，必须使用迭代器：\\n```java\\nIterator<Account> it = accounts.iterator();\\nwhile (it.hasNext()) {\\n    Account acc = it.next();\\n    if (acc.getBalance() < 0) {\\n        it.remove(); // 安全删除\\n    }\\n}\\n```\\n\\n## 实战：银行账户管理系统中的集合应用\\n\\n结合上一篇的异常处理，我们完善一个银行类：\\n```java\\nimport java.util.*;\\nimport org.slf4j.Logger;\\nimport org.slf4j.LoggerFactory;\\n\\npublic class Bank {\\n    private static final Logger logger = LoggerFactory.getLogger(Bank.class);\\n    private Map<String, Account> accountMap = new HashMap<>();\\n    \\n    public void createAccount(String accountNumber, String owner, double initialBalance) {\\n        if (accountMap.containsKey(accountNumber)) {\\n            logger.warn(\\\"账户已存在: {}\\\", accountNumber);\\n            throw new IllegalArgumentException(\\\"账户号重复\\\");\\n        }\\n        Account account = new Account(accountNumber, owner, initialBalance);\\n        accountMap.put(accountNumber, account);\\n        logger.info(\\\"创建账户成功: {}\\\", accountNumber);\\n    }\\n    \\n    public void transfer(String from, String to, double amount) {\\n        Account fromAcc = accountMap.get(from);\\n        Account toAcc = accountMap.get(to);\\n        if (fromAcc == null || toAcc == null) {\\n            logger.error(\\\"转账失败，账户不存在: from={}, to={}\\\", from, to);\\n            throw new IllegalArgumentException(\\\"账户不存在\\\");\\n        }\\n        fromAcc.withdraw(amount);\\n        toAcc.deposit(amount);\\n        logger.info(\\\"转账成功: {} -> {}，金额{}\\\", from, to, amount);\\n    }\\n}\\n```\\n\\n这里，Map提供了O(1)的账户查找，而异常处理和日志记录确保了系统的健壮性。\\n\\n## 最佳实践\\n\\n1. **优先使用接口引用**：如`List<String> list = new ArrayList<>()`，便于切换实现。\\n2. **合理选择实现类**：根据访问模式（随机访问 vs 插入删除）选择ArrayList或LinkedList。\\n3. **使用泛型避免类型转换**：减少运行时错误。\\n4. **迭代时删除使用Iterator**：避免ConcurrentModificationException。\\n5. **考虑线程安全**：多线程环境使用`Collections.synchronizedXXX()`或`ConcurrentHashMap`。\\n\\n## 小结\\n\\n今天，我们见证了从数组到泛型集合的进化。集合框架让数据管理更灵活、更安全，而泛型则提供了编译时的类型检查。在银行系统中，Map和List的组合让账户管理变得高效。下一篇，我们将探索Java I/O流，学习如何读写文件，比如导出交易记录。\\n\\n## 思考题\\n\\n1. 为什么ArrayList的插入操作在中间位置性能较差？\\n2. 在银行系统中，如果客户数量巨大，你会选择HashMap还是TreeMap？为什么？\\n3. 如何用Set实现账户号的唯一性校验？\",\"nextTopic\":\"Java I/O流：文件读写与序列化\"},\"outline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"topic\":\"30天Java进阶\",\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\",\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\",\"银行账户系统（集合框架）\",\"交易记录管理（List与Map）\",\"账户排序（TreeSet）\"],\"isComplete\":false,\"seriesState\":\"{\\n  \\\"article\\\": {\\n    \\\"title\\\": \\\"第2篇：集合框架——从数组到泛型集合的进化\\\",\\n    \\\"content\\\": \\\"在上一篇中，我们深入探讨了Java的异常处理与日志记录，确保你的银行账户系统能优雅地处理错误。今天，我们将转向另一个核心话题：集合框架。想象一下，你的银行系统需要管理成千上万的客户账户——数组固然简单，但它的固定长度和缺乏灵活性会让你头疼不已。Java的集合框架（Collections Framework）正是为此而生，它提供了动态、高效的数据结构。\\\\n\\\\n## 从数组到集合的痛点\\\\n\\\\n数组是Java中最基础的数据结构，但它的局限性很明显：\\\\n- 长度固定：一旦创建，无法动态增长。\\\\n- 类型单一：只能存储同一种类型。\\\\n- 操作繁琐：增删元素需要手动移动数据。\\\\n\\\\n例如，在银行系统中，我们可能需要记录客户的交易历史。使用数组：\\\\n```java\\\\nString[] transactions = new String[100]; // 假设最多100条\\\\nint count = 0;\\\\ntransactions[count++] = \\\\\\\"存款1000元\\\\\\\";\\\\ntransactions[count++] = \\\\\\\"取款500元\\\\\\\";\\\\n// 如果超过100条，必须新建数组并复制数据\\\\n```\\\\n\\\\n这显然不够灵活。集合框架的出现，让我们能用更少的代码实现动态管理。\\\\n\\\\n## 集合框架的三大核心接口\\\\n\\\\nJava集合框架以接口为核心，主要分为三大类：\\\\n1. **List**：有序、可重复的集合（类似动态数组）。\\\\n2. **Set**：无序、不可重复的集合（类似数学中的集合）。\\\\n3. **Map**：键值对映射，键不可重复。\\\\n\\\\n### 泛型：让集合更安全\\\\n\\\\n在Java 5之前，集合默认存储Object类型，需要强制类型转换，容易引发ClassCastException。泛型（Generics）的出现解决了这个问题：\\\\n```java\\\\n// 没有泛型（旧式）\\\\nList accounts = new ArrayList();\\\\naccounts.add(\\\\\\\"张三\\\\\\\"); // 自动向上转型为Object\\\\nString name = (String) accounts.get(0); // 必须强制转换\\\\n\\\\n// 使用泛型（推荐）\\\\nList<String> accounts = new ArrayList<>();\\\\naccounts.add(\\\\\\\"张三\\\\\\\");\\\\nString name = accounts.get(0); // 无需转换，类型安全\\\\n```\\\\n\\\\n在银行系统中，我们可以用泛型集合管理账户：\\\\n```java\\\\npublic class Bank {\\\\n    private List<Account> accounts = new ArrayList<>();\\\\n    \\\\n    public void addAccount(Account account) {\\\\n        accounts.add(account);\\\\n    }\\\\n    \\\\n    public Account findAccount(String accountNumber) {\\\\n        for (Account acc : accounts) {\\\\n            if (acc.getAccountNumber().equals(accountNumber)) {\\\\n                return acc;\\\\n            }\\\\n        }\\\\n        return null;\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 常用实现类详解\\\\n\\\\n### ArrayList vs LinkedList\\\\n- **ArrayList**：基于动态数组，随机访问快（O(1)），但插入删除慢（O(n)）。\\\\n- **LinkedList**：基于双向链表，插入删除快（O(1)），但随机访问慢（O(n)）。\\\\n\\\\n示例：记录交易日志，如果频繁追加，ArrayList更合适；如果频繁在头部插入，LinkedList更优。\\\\n\\\\n### HashSet vs TreeSet\\\\n- **HashSet**：基于哈希表，无序，查找快（O(1)）。\\\\n- **TreeSet**：基于红黑树，自动排序，查找稍慢（O(log n)）。\\\\n\\\\n在银行系统中，如果我们需要按账户余额排序，可以用TreeSet：\\\\n```java\\\\nSet<Account> sortedAccounts = new TreeSet<>((a1, a2) -> \\\\n    Double.compare(a1.getBalance(), a2.getBalance()));\\\\n```\\\\n\\\\n### HashMap vs TreeMap\\\\n- **HashMap**：基于哈希表，键无序，查找快（O(1)）。\\\\n- **TreeMap**：基于红黑树，键自动排序。\\\\n\\\\n例如，用Map存储客户ID与账户的映射：\\\\n```java\\\\nMap<String, Account> accountMap = new HashMap<>();\\\\naccountMap.put(\\\\\\\"C001\\\\\\\", new Account(\\\\\\\"张三\\\\\\\", 1000));\\\\nAccount acc = accountMap.get(\\\\\\\"C001\\\\\\\"); // 快速查找\\\\n```\\\\n\\\\n## 迭代器与增强for循环\\\\n\\\\n遍历集合时，增强for循环（for-each）更简洁：\\\\n```java\\\\nfor (Account acc : accounts) {\\\\n    System.out.println(acc.getOwner());\\\\n}\\\\n```\\\\n\\\\n但需要删除元素时，必须使用迭代器：\\\\n```java\\\\nIterator<Account> it = accounts.iterator();\\\\nwhile (it.hasNext()) {\\\\n    Account acc = it.next();\\\\n    if (acc.getBalance() < 0) {\\\\n        it.remove(); // 安全删除\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 实战：银行账户管理系统中的集合应用\\\\n\\\\n结合上一篇的异常处理，我们完善一个银行类：\\\\n```java\\\\nimport java.util.*;\\\\nimport org.slf4j.Logger;\\\\nimport org.slf4j.LoggerFactory;\\\\n\\\\npublic class Bank {\\\\n    private static final Logger logger = LoggerFactory.getLogger(Bank.class);\\\\n    private Map<String, Account> accountMap = new HashMap<>();\\\\n    \\\\n    public void createAccount(String accountNumber, String owner, double initialBalance) {\\\\n        if (accountMap.containsKey(accountNumber)) {\\\\n            logger.warn(\\\\\\\"账户已存在: {}\\\\\\\", accountNumber);\\\\n            throw new IllegalArgumentException(\\\\\\\"账户号重复\\\\\\\");\\\\n        }\\\\n        Account account = new Account(accountNumber, owner, initialBalance);\\\\n        accountMap.put(accountNumber, account);\\\\n        logger.info(\\\\\\\"创建账户成功: {}\\\\\\\", accountNumber);\\\\n    }\\\\n    \\\\n    public void transfer(String from, String to, double amount) {\\\\n        Account fromAcc = accountMap.get(from);\\\\n        Account toAcc = accountMap.get(to);\\\\n        if (fromAcc == null || toAcc == null) {\\\\n            logger.error(\\\\\\\"转账失败，账户不存在: from={}, to={}\\\\\\\", from, to);\\\\n            throw new IllegalArgumentException(\\\\\\\"账户不存在\\\\\\\");\\\\n        }\\\\n        fromAcc.withdraw(amount);\\\\n        toAcc.deposit(amount);\\\\n        logger.info(\\\\\\\"转账成功: {} -> {}，金额{}\\\\\\\", from, to, amount);\\\\n    }\\\\n}\\\\n```\\\\n\\\\n这里，Map提供了O(1)的账户查找，而异常处理和日志记录确保了系统的健壮性。\\\\n\\\\n## 最佳实践\\\\n\\\\n1. **优先使用接口引用**：如`List<String> list = new ArrayList<>()`，便于切换实现。\\\\n2. **合理选择实现类**：根据访问模式（随机访问 vs 插入删除）选择ArrayList或LinkedList。\\\\n3. **使用泛型避免类型转换**：减少运行时错误。\\\\n4. **迭代时删除使用Iterator**：避免ConcurrentModificationException。\\\\n5. **考虑线程安全**：多线程环境使用`Collections.synchronizedXXX()`或`ConcurrentHashMap`。\\\\n\\\\n## 小结\\\\n\\\\n今天，我们见证了从数组到泛型集合的进化。集合框架让数据管理更灵活、更安全，而泛型则提供了编译时的类型检查。在银行系统中，Map和List的组合让账户管理变得高效。下一篇，我们将探索Java I/O流，学习如何读写文件，比如导出交易记录。\\\\n\\\\n## 思考题\\\\n\\\\n1. 为什么ArrayList的插入操作在中间位置性能较差？\\\\n2. 在银行系统中，如果客户数量巨大，你会选择HashMap还是TreeMap？为什么？\\\\n3. 如何用Set实现账户号的唯一性校验？\\\",\\n    \\\"nextTopic\\\": \\\"Java I/O流：文件读写与序列化\\\"\\n  },\\n  \\\"outline\\\": [\\n    \\\"第1篇：异常处理与日志记录——银行系统的稳健之道\\\",\\n    \\\"第2篇：集合框架——从数组到泛型集合的进化\\\",\\n    \\\"第3篇：Java I/O流——文件读写与序列化\\\",\\n    \\\"第4篇：多线程基础——银行系统的并发挑战\\\",\\n    \\\"第5篇：网络编程——Socket通信与RMI\\\",\\n    \\\"第6篇：JDBC与数据库操作——持久化银行数据\\\",\\n    \\\"第7篇：反射与注解——框架的基石\\\",\\n    \\\"第8篇：Lambda表达式与Stream API——函数式编程实战\\\",\\n    \\\"第9篇：设计模式——单例、工厂与观察者\\\",\\n    \\\"第10篇：JVM内存模型与性能调优\\\",\\n    \\\"第11篇：单元测试与Mock——JUnit与Mockito\\\",\\n    \\\"第12篇：构建工具——Maven与Gradle\\\",\\n    \\\"第13篇：版本控制——Git进阶\\\",\\n    \\\"第14篇：Spring基础——依赖注入与AOP\\\",\\n    \\\"第15篇：Spring Boot——快速搭建银行系统\\\",\\n    \\\"第16篇：MyBatis——ORM实战\\\",\\n    \\\"第17篇：RESTful API设计\\\",\\n    \\\"第18篇：微服务入门——Spring Cloud\\\",\\n    \\\"第19篇：Docker容器化部署\\\",\\n    \\\"第20篇：持续集成/持续部署——Jenkins\\\",\\n    \\\"第21篇：消息队列——RabbitMQ与Kafka\\\",\\n    \\\"第22篇：缓存技术——Redis\\\",\\n    \\\"第23篇：搜索引擎——Elasticsearch\\\",\\n    \\\"第24篇：安全机制——认证与授权\\\",\\n    \\\"第25篇：性能测试——JMeter\\\",\\n    \\\"第26篇：日志聚合——ELK Stack\\\",\\n    \\\"第27篇：监控与告警——Prometheus与Grafana\\\",\\n    \\\"第28篇：分布式事务——Seata\\\",\\n    \\\"第29篇：容器编排——Kubernetes\\\",\\n    \\\"第30篇：项目总结——银行系统完整实现\\\"\\n  ],\\n  \\\"usedExamples\\\": [\\n    \\\"银行账户系统（异常处理）\\\",\\n    \\\"文件读取（try-with-resources）\\\",\\n    \\\"自定义异常类\\\",\\n    \\\"银行账户系统（集合框架）\\\",\\n    \\\"交易记录管理（List与Map）\\\",\\n    \\\"账户排序（TreeSet）\\\"\\n  ],\\n  \\\"coveredTopics\\\": [\\n    \\\"异常体系\\\",\\n    \\\"try-catch-finally\\\",\\n    \\\"多重捕获\\\",\\n    \\\"try-with-resources\\\",\\n    \\\"自定义异常\\\",\\n    \\\"SLF4J与Logback日志\\\",\\n    \\\"日志级别\\\",\\n    \\\"最佳实践\\\",\\n    \\\"集合框架概述\\\",\\n    \\\"List接口与ArrayList/LinkedList\\\",\\n    \\\"Set接口与HashSet/TreeSet\\\",\\n    \\\"Map接口与HashMap/TreeMap\\\",\\n    \\\"泛型\\\",\\n    \\\"迭代器与增强for循环\\\",\\n    \\\"集合最佳实践\\\"\\n  ],\\n  \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\\\",\\n  \\\"isComplete\\\": false\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 3, 8, NULL, 'Connect to http://127.0.0.1:8080 failed: Connection refused: getsockopt', '2026-07-08 19:38:32', '2026-07-08 19:23:11', '2026-07-08 19:36:13');
INSERT INTO `ai_webhook_delivery` VALUES (3, 'blog_series_writer-chain-demo01-3', 'blog_series_writer-69dafb9017ce4f74aa3c2d00c1d84ceb', 'blog_series_writer-chain-demo01', 3, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-3\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":3,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-69dafb9017ce4f74aa3c2d00c1d84ceb\",\"context\":{\"updatedState\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\",\"文件复制（字节流）\",\"读取交易日志（字符流）\",\"序列化银行账户对象\",\"银行数据管理器\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\",\"I/O流基础\",\"字节流与字符流\",\"缓冲流\",\"对象序列化\",\"transient关键字\",\"serialVersionUID\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，以及I/O流和序列化的应用。\"},\"outline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"prevSeq\":2,\"isSeriesComplete\":false,\"updatedOutline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"topic\":\"30天Java进阶\",\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"article\":{\"title\":\"第3篇：Java I/O流——文件读写与序列化\",\"content\":\"在前两篇中，我们学习了异常处理和集合框架，为银行系统打下了稳健的基础。今天，我们将深入Java I/O流，探讨如何高效地读写文件以及实现对象的序列化。在银行系统中，文件读写用于存储交易日志、客户信息等，而序列化则能轻松保存和恢复账户对象。让我们通过实战示例，掌握这些核心技能。\\n\\n## 1. I/O流基础\\nJava I/O流分为字节流和字符流。字节流处理二进制数据（如图片、文件），字符流处理文本数据。核心抽象类：\\n- 字节流：InputStream（读）和OutputStream（写）\\n- 字符流：Reader（读）和Writer（写）\\n\\n### 示例：使用字节流复制文件\\n```java\\nimport java.io.*;\\n\\npublic class FileCopy {\\n    public static void main(String[] args) {\\n        try (FileInputStream fis = new FileInputStream(\\\"source.txt\\\");\\n             FileOutputStream fos = new FileOutputStream(\\\"dest.txt\\\")) {\\n            byte[] buffer = new byte[1024];\\n            int bytesRead;\\n            while ((bytesRead = fis.read(buffer)) != -1) {\\n                fos.write(buffer, 0, bytesRead);\\n            }\\n            System.out.println(\\\"文件复制成功\\\");\\n        } catch (IOException e) {\\n            System.err.println(\\\"文件复制失败: \\\" + e.getMessage());\\n        }\\n    }\\n}\\n```\\n这里使用了try-with-resources自动关闭资源，这是第1篇中强调的最佳实践。\\n\\n## 2. 字符流与缓冲流\\n字符流适合处理文本，缓冲流提高性能。\\n\\n### 示例：读取银行交易日志\\n```java\\nimport java.io.*;\\n\\npublic class LogReader {\\n    public static void main(String[] args) {\\n        try (BufferedReader reader = new BufferedReader(new FileReader(\\\"transactions.log\\\"))) {\\n            String line;\\n            while ((line = reader.readLine()) != null) {\\n                System.out.println(\\\"交易记录: \\\" + line);\\n            }\\n        } catch (IOException e) {\\n            System.err.println(\\\"读取日志失败: \\\" + e.getMessage());\\n        }\\n    }\\n}\\n```\\nBufferedReader提供了readLine()方法，按行读取，效率更高。\\n\\n## 3. 对象序列化\\n序列化将对象转换为字节流，便于存储或网络传输。Java通过实现Serializable接口支持。\\n\\n### 示例：序列化银行账户对象\\n```java\\nimport java.io.*;\\n\\nclass BankAccount implements Serializable {\\n    private static final long serialVersionUID = 1L; // 版本控制\\n    private String accountId;\\n    private double balance;\\n    private transient String password; // transient字段不序列化\\n\\n    public BankAccount(String accountId, double balance, String password) {\\n        this.accountId = accountId;\\n        this.balance = balance;\\n        this.password = password;\\n    }\\n\\n    @Override\\n    public String toString() {\\n        return \\\"BankAccount{accountId=\'\\\" + accountId + \\\"\', balance=\\\" + balance + \\\"}\\\";\\n    }\\n}\\n\\npublic class SerializationDemo {\\n    public static void main(String[] args) {\\n        BankAccount account = new BankAccount(\\\"ACC001\\\", 1000.0, \\\"secret123\\\");\\n        \\n        // 序列化\\n        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(\\\"account.ser\\\"))) {\\n            oos.writeObject(account);\\n            System.out.println(\\\"账户序列化成功\\\");\\n        } catch (IOException e) {\\n            System.err.println(\\\"序列化失败: \\\" + e.getMessage());\\n        }\\n        \\n        // 反序列化\\n        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(\\\"account.ser\\\"))) {\\n            BankAccount deserializedAccount = (BankAccount) ois.readObject();\\n            System.out.println(\\\"反序列化账户: \\\" + deserializedAccount);\\n        } catch (IOException | ClassNotFoundException e) {\\n            System.err.println(\\\"反序列化失败: \\\" + e.getMessage());\\n        }\\n    }\\n}\\n```\\n注意：transient关键字标记的字段（如password）不会被序列化，保护敏感信息。serialVersionUID确保版本兼容。\\n\\n## 4. 在银行系统中的应用\\n结合前两篇的异常处理和集合框架，我们可以设计一个简单的银行数据持久化方案：\\n- 使用文件存储交易日志（字符流）\\n- 使用序列化保存账户集合（对象流）\\n\\n```java\\nimport java.io.*;\\nimport java.util.*;\\n\\npublic class BankDataManager {\\n    private Map<String, BankAccount> accounts = new HashMap<>();\\n    \\n    public void loadAccounts() {\\n        File file = new File(\\\"accounts.dat\\\");\\n        if (file.exists()) {\\n            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file))) {\\n                accounts = (Map<String, BankAccount>) ois.readObject();\\n            } catch (IOException | ClassNotFoundException e) {\\n                System.err.println(\\\"加载账户失败: \\\" + e.getMessage());\\n                accounts = new HashMap<>();\\n            }\\n        }\\n    }\\n    \\n    public void saveAccounts() {\\n        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(\\\"accounts.dat\\\"))) {\\n            oos.writeObject(accounts);\\n        } catch (IOException e) {\\n            System.err.println(\\\"保存账户失败: \\\" + e.getMessage());\\n        }\\n    }\\n    \\n    public void addAccount(BankAccount account) {\\n        accounts.put(account.getAccountId(), account);\\n        saveAccounts();\\n    }\\n}\\n```\\n这个类使用HashMap存储账户，并通过序列化持久化到文件。\\n\\n## 5. 最佳实践\\n- 使用缓冲流提高性能\\n- 始终关闭流资源（try-with-resources）\\n- 序列化时注意敏感字段的transient\\n- 定义serialVersionUID管理版本\\n- 异常处理结合日志记录（如SLF4J）\\n\\n## 总结\\n本篇学习了Java I/O流的字节流、字符流、缓冲流以及对象序列化。这些技术是银行系统文件读写和数据持久化的基础。下一篇我们将进入多线程基础，探讨银行系统面临的并发挑战。\",\"nextTopic\":\"第4篇：多线程基础——银行系统的并发挑战\"},\"seriesState\":\"{\\n  \\\"article\\\": {\\n    \\\"title\\\": \\\"第3篇：Java I/O流——文件读写与序列化\\\",\\n    \\\"content\\\": \\\"在前两篇中，我们学习了异常处理和集合框架，为银行系统打下了稳健的基础。今天，我们将深入Java I/O流，探讨如何高效地读写文件以及实现对象的序列化。在银行系统中，文件读写用于存储交易日志、客户信息等，而序列化则能轻松保存和恢复账户对象。让我们通过实战示例，掌握这些核心技能。\\\\n\\\\n## 1. I/O流基础\\\\nJava I/O流分为字节流和字符流。字节流处理二进制数据（如图片、文件），字符流处理文本数据。核心抽象类：\\\\n- 字节流：InputStream（读）和OutputStream（写）\\\\n- 字符流：Reader（读）和Writer（写）\\\\n\\\\n### 示例：使用字节流复制文件\\\\n```java\\\\nimport java.io.*;\\\\n\\\\npublic class FileCopy {\\\\n    public static void main(String[] args) {\\\\n        try (FileInputStream fis = new FileInputStream(\\\\\\\"source.txt\\\\\\\");\\\\n             FileOutputStream fos = new FileOutputStream(\\\\\\\"dest.txt\\\\\\\")) {\\\\n            byte[] buffer = new byte[1024];\\\\n            int bytesRead;\\\\n            while ((bytesRead = fis.read(buffer)) != -1) {\\\\n                fos.write(buffer, 0, bytesRead);\\\\n            }\\\\n            System.out.println(\\\\\\\"文件复制成功\\\\\\\");\\\\n        } catch (IOException e) {\\\\n            System.err.println(\\\\\\\"文件复制失败: \\\\\\\" + e.getMessage());\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n这里使用了try-with-resources自动关闭资源，这是第1篇中强调的最佳实践。\\\\n\\\\n## 2. 字符流与缓冲流\\\\n字符流适合处理文本，缓冲流提高性能。\\\\n\\\\n### 示例：读取银行交易日志\\\\n```java\\\\nimport java.io.*;\\\\n\\\\npublic class LogReader {\\\\n    public static void main(String[] args) {\\\\n        try (BufferedReader reader = new BufferedReader(new FileReader(\\\\\\\"transactions.log\\\\\\\"))) {\\\\n            String line;\\\\n            while ((line = reader.readLine()) != null) {\\\\n                System.out.println(\\\\\\\"交易记录: \\\\\\\" + line);\\\\n            }\\\\n        } catch (IOException e) {\\\\n            System.err.println(\\\\\\\"读取日志失败: \\\\\\\" + e.getMessage());\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\nBufferedReader提供了readLine()方法，按行读取，效率更高。\\\\n\\\\n## 3. 对象序列化\\\\n序列化将对象转换为字节流，便于存储或网络传输。Java通过实现Serializable接口支持。\\\\n\\\\n### 示例：序列化银行账户对象\\\\n```java\\\\nimport java.io.*;\\\\n\\\\nclass BankAccount implements Serializable {\\\\n    private static final long serialVersionUID = 1L; // 版本控制\\\\n    private String accountId;\\\\n    private double balance;\\\\n    private transient String password; // transient字段不序列化\\\\n\\\\n    public BankAccount(String accountId, double balance, String password) {\\\\n        this.accountId = accountId;\\\\n        this.balance = balance;\\\\n        this.password = password;\\\\n    }\\\\n\\\\n    @Override\\\\n    public String toString() {\\\\n        return \\\\\\\"BankAccount{accountId=\'\\\\\\\" + accountId + \\\\\\\"\', balance=\\\\\\\" + balance + \\\\\\\"}\\\\\\\";\\\\n    }\\\\n}\\\\n\\\\npublic class SerializationDemo {\\\\n    public static void main(String[] args) {\\\\n        BankAccount account = new BankAccount(\\\\\\\"ACC001\\\\\\\", 1000.0, \\\\\\\"secret123\\\\\\\");\\\\n        \\\\n        // 序列化\\\\n        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(\\\\\\\"account.ser\\\\\\\"))) {\\\\n            oos.writeObject(account);\\\\n            System.out.println(\\\\\\\"账户序列化成功\\\\\\\");\\\\n        } catch (IOException e) {\\\\n            System.err.println(\\\\\\\"序列化失败: \\\\\\\" + e.getMessage());\\\\n        }\\\\n        \\\\n        // 反序列化\\\\n        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(\\\\\\\"account.ser\\\\\\\"))) {\\\\n            BankAccount deserializedAccount = (BankAccount) ois.readObject();\\\\n            System.out.println(\\\\\\\"反序列化账户: \\\\\\\" + deserializedAccount);\\\\n        } catch (IOException | ClassNotFoundException e) {\\\\n            System.err.println(\\\\\\\"反序列化失败: \\\\\\\" + e.getMessage());\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n注意：transient关键字标记的字段（如password）不会被序列化，保护敏感信息。serialVersionUID确保版本兼容。\\\\n\\\\n## 4. 在银行系统中的应用\\\\n结合前两篇的异常处理和集合框架，我们可以设计一个简单的银行数据持久化方案：\\\\n- 使用文件存储交易日志（字符流）\\\\n- 使用序列化保存账户集合（对象流）\\\\n\\\\n```java\\\\nimport java.io.*;\\\\nimport java.util.*;\\\\n\\\\npublic class BankDataManager {\\\\n    private Map<String, BankAccount> accounts = new HashMap<>();\\\\n    \\\\n    public void loadAccounts() {\\\\n        File file = new File(\\\\\\\"accounts.dat\\\\\\\");\\\\n        if (file.exists()) {\\\\n            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file))) {\\\\n                accounts = (Map<String, BankAccount>) ois.readObject();\\\\n            } catch (IOException | ClassNotFoundException e) {\\\\n                System.err.println(\\\\\\\"加载账户失败: \\\\\\\" + e.getMessage());\\\\n                accounts = new HashMap<>();\\\\n            }\\\\n        }\\\\n    }\\\\n    \\\\n    public void saveAccounts() {\\\\n        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(\\\\\\\"accounts.dat\\\\\\\"))) {\\\\n            oos.writeObject(accounts);\\\\n        } catch (IOException e) {\\\\n            System.err.println(\\\\\\\"保存账户失败: \\\\\\\" + e.getMessage());\\\\n        }\\\\n    }\\\\n    \\\\n    public void addAccount(BankAccount account) {\\\\n        accounts.put(account.getAccountId(), account);\\\\n        saveAccounts();\\\\n    }\\\\n}\\\\n```\\\\n这个类使用HashMap存储账户，并通过序列化持久化到文件。\\\\n\\\\n## 5. 最佳实践\\\\n- 使用缓冲流提高性能\\\\n- 始终关闭流资源（try-with-resources）\\\\n- 序列化时注意敏感字段的transient\\\\n- 定义serialVersionUID管理版本\\\\n- 异常处理结合日志记录（如SLF4J）\\\\n\\\\n## 总结\\\\n本篇学习了Java I/O流的字节流、字符流、缓冲流以及对象序列化。这些技术是银行系统文件读写和数据持久化的基础。下一篇我们将进入多线程基础，探讨银行系统面临的并发挑战。\\\",\\n    \\\"nextTopic\\\": \\\"第4篇：多线程基础——银行系统的并发挑战\\\"\\n  },\\n  \\\"updatedOutline\\\": [\\n    \\\"第1篇：异常处理与日志记录——银行系统的稳健之道\\\",\\n    \\\"第2篇：集合框架——从数组到泛型集合的进化\\\",\\n    \\\"第3篇：Java I/O流——文件读写与序列化\\\",\\n    \\\"第4篇：多线程基础——银行系统的并发挑战\\\",\\n    \\\"第5篇：网络编程——Socket通信与RMI\\\",\\n    \\\"第6篇：JDBC与数据库操作——持久化银行数据\\\",\\n    \\\"第7篇：反射与注解——框架的基石\\\",\\n    \\\"第8篇：Lambda表达式与Stream API——函数式编程实战\\\",\\n    \\\"第9篇：设计模式——单例、工厂与观察者\\\",\\n    \\\"第10篇：JVM内存模型与性能调优\\\",\\n    \\\"第11篇：单元测试与Mock——JUnit与Mockito\\\",\\n    \\\"第12篇：构建工具——Maven与Gradle\\\",\\n    \\\"第13篇：版本控制——Git进阶\\\",\\n    \\\"第14篇：Spring基础——依赖注入与AOP\\\",\\n    \\\"第15篇：Spring Boot——快速搭建银行系统\\\",\\n    \\\"第16篇：MyBatis——ORM实战\\\",\\n    \\\"第17篇：RESTful API设计\\\",\\n    \\\"第18篇：微服务入门——Spring Cloud\\\",\\n    \\\"第19篇：Docker容器化部署\\\",\\n    \\\"第20篇：持续集成/持续部署——Jenkins\\\",\\n    \\\"第21篇：消息队列——RabbitMQ与Kafka\\\",\\n    \\\"第22篇：缓存技术——Redis\\\",\\n    \\\"第23篇：搜索引擎——Elasticsearch\\\",\\n    \\\"第24篇：安全机制——认证与授权\\\",\\n    \\\"第25篇：性能测试——JMeter\\\",\\n    \\\"第26篇：日志聚合——ELK Stack\\\",\\n    \\\"第27篇：监控与告警——Prometheus与Grafana\\\",\\n    \\\"第28篇：分布式事务——Seata\\\",\\n    \\\"第29篇：容器编排——Kubernetes\\\",\\n    \\\"第30篇：项目总结——银行系统完整实现\\\"\\n  ],\\n  \\\"updatedState\\\": {\\n    \\\"usedExamples\\\": [\\\"银行账户系统（异常处理）\\\", \\\"文件读取（try-with-resources）\\\", \\\"自定义异常类\\\", \\\"文件复制（字节流）\\\", \\\"读取交易日志（字符流）\\\", \\\"序列化银行账户对象\\\", \\\"银行数据管理器\\\"],\\n    \\\"coveredTopics\\\": [\\\"异常体系\\\", \\\"try-catch-finally\\\", \\\"多重捕获\\\", \\\"try-with-resources\\\", \\\"自定义异常\\\", \\\"SLF4J与Logback日志\\\", \\\"日志级别\\\", \\\"最佳实践\\\", \\\"I/O流基础\\\", \\\"字节流与字符流\\\", \\\"缓冲流\\\", \\\"对象序列化\\\", \\\"transient关键字\\\", \\\"serialVersionUID\\\"],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，以及I/O流和序列化的应用。\\\"\\n  },\\n  \\\"isSeriesComplete\\\": false\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 3, 8, NULL, 'Connect to http://127.0.0.1:8080 failed: Connection refused: getsockopt', '2026-07-08 19:40:21', '2026-07-08 19:24:26', '2026-07-08 19:36:13');
INSERT INTO `ai_webhook_delivery` VALUES (4, 'blog_series_writer-chain-demo01-4', 'blog_series_writer-ad495ce59e004ab284090f52cf37579c', 'blog_series_writer-chain-demo01', 4, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-4\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":4,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-ad495ce59e004ab284090f52cf37579c\",\"context\":{\"outline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"prevSeq\":3,\"topic\":\"30天Java进阶\",\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"nextArticle\":{\"title\":\"第4篇：多线程基础——银行系统的并发挑战\",\"content\":\"## 前言\\n在前三篇文章中，我们构建了银行系统的稳健基础：异常处理与日志记录确保了错误可控，集合框架优化了数据管理，I/O流实现了文件持久化。然而，现实中的银行系统必须同时服务成千上万的客户——存款、取款、转账并发执行。这就是多线程的舞台。本篇将带你深入Java多线程基础，以银行账户并发操作为实战案例，揭示竞态条件、锁机制与线程协作的奥秘。\\n\\n## 1. 为什么需要多线程？——银行系统的并发场景\\n假设一个银行账户初始余额为1000元。两个线程同时执行取款操作：线程A取800元，线程B取500元。如果没有同步机制，可能出现以下错误流程：\\n1. 线程A读取余额1000，判断足够。\\n2. 线程B读取余额1000，判断足够。\\n3. 线程A扣减800，余额变为200。\\n4. 线程B扣减500，余额变为500（实际应为-300，但被覆盖）。\\n\\n这就是经典的**竞态条件**。多线程编程的核心就是协调线程对共享资源的访问。\\n\\n## 2. 创建线程的两种方式\\n### 2.1 继承Thread类\\n```java\\npublic class DepositThread extends Thread {\\n    private BankAccount account;\\n    private double amount;\\n    \\n    public DepositThread(BankAccount account, double amount) {\\n        this.account = account;\\n        this.amount = amount;\\n    }\\n    \\n    @Override\\n    public void run() {\\n        account.deposit(amount);\\n    }\\n}\\n```\\n\\n### 2.2 实现Runnable接口（推荐）\\n```java\\npublic class WithdrawTask implements Runnable {\\n    private BankAccount account;\\n    private double amount;\\n    \\n    public WithdrawTask(BankAccount account, double amount) {\\n        this.account = account;\\n        this.amount = amount;\\n    }\\n    \\n    @Override\\n    public void run() {\\n        account.withdraw(amount);\\n    }\\n}\\n\\n// 使用\\nThread t = new Thread(new WithdrawTask(account, 500));\\nt.start();\\n```\\n\\n## 3. 线程安全问题与synchronized\\n### 3.1 问题重现\\n```java\\npublic class BankAccount {\\n    private double balance;\\n    \\n    public void withdraw(double amount) {\\n        if (balance >= amount) {\\n            // 模拟网络延迟\\n            try { Thread.sleep(10); } catch (InterruptedException e) {}\\n            balance -= amount;\\n            System.out.println(Thread.currentThread().getName() + \\\" 取款成功，余额：\\\" + balance);\\n        } else {\\n            System.out.println(\\\"余额不足\\\");\\n        }\\n    }\\n}\\n```\\n### 3.2 使用synchronized解决\\n```java\\npublic synchronized void withdraw(double amount) {\\n    // 方法体同上\\n}\\n```\\n`synchronized`保证同一时刻只有一个线程能执行该方法。但注意：synchronized会降低并发性能，且可能导致死锁。\\n\\n## 4. 更细粒度的锁：ReentrantLock\\n```java\\nimport java.util.concurrent.locks.ReentrantLock;\\n\\npublic class BankAccount {\\n    private double balance;\\n    private final ReentrantLock lock = new ReentrantLock();\\n    \\n    public void withdraw(double amount) {\\n        lock.lock();\\n        try {\\n            if (balance >= amount) {\\n                Thread.sleep(10);\\n                balance -= amount;\\n                System.out.println(Thread.currentThread().getName() + \\\" 取款成功，余额：\\\" + balance);\\n            } else {\\n                System.out.println(\\\"余额不足\\\");\\n            }\\n        } catch (InterruptedException e) {\\n            Thread.currentThread().interrupt();\\n        } finally {\\n            lock.unlock();\\n        }\\n    }\\n}\\n```\\nReentrantLock提供更灵活的锁控制，如可中断锁、公平锁等。\\n\\n## 5. 线程间协作：wait/notify\\n考虑一个场景：多个线程从队列中取任务，队列为空时线程等待，有任务时被唤醒。\\n```java\\nimport java.util.LinkedList;\\nimport java.util.Queue;\\n\\npublic class TaskQueue {\\n    private Queue<String> queue = new LinkedList<>();\\n    \\n    public synchronized void addTask(String task) {\\n        queue.add(task);\\n        notifyAll(); // 唤醒等待的线程\\n    }\\n    \\n    public synchronized String getTask() throws InterruptedException {\\n        while (queue.isEmpty()) {\\n            wait(); // 等待任务\\n        }\\n        return queue.poll();\\n    }\\n}\\n```\\n\\n## 6. 线程池——管理线程的利器\\n手动创建线程开销大，且难以控制数量。使用`ExecutorService`：\\n```java\\nimport java.util.concurrent.ExecutorService;\\nimport java.util.concurrent.Executors;\\n\\npublic class BankService {\\n    private ExecutorService executor = Executors.newFixedThreadPool(10); // 固定10个线程\\n    \\n    public void processTransaction(Runnable task) {\\n        executor.submit(task);\\n    }\\n    \\n    public void shutdown() {\\n        executor.shutdown();\\n    }\\n}\\n```\\n\\n## 7. 实战：银行转账系统\\n```java\\npublic class TransferTask implements Runnable {\\n    private BankAccount from;\\n    private BankAccount to;\\n    private double amount;\\n    \\n    public TransferTask(BankAccount from, BankAccount to, double amount) {\\n        this.from = from;\\n        this.to = to;\\n        this.amount = amount;\\n    }\\n    \\n    @Override\\n    public void run() {\\n        // 避免死锁：按账户ID顺序获取锁\\n        int fromHash = System.identityHashCode(from);\\n        int toHash = System.identityHashCode(to);\\n        Object lock1 = fromHash < toHash ? from : to;\\n        Object lock2 = fromHash < toHash ? to : from;\\n        \\n        synchronized (lock1) {\\n            synchronized (lock2) {\\n                from.withdraw(amount);\\n                to.deposit(amount);\\n            }\\n        }\\n    }\\n}\\n```\\n\\n## 8. 线程安全最佳实践\\n- 优先使用`java.util.concurrent`包中的并发集合（如`ConcurrentHashMap`）\\n- 避免使用`Thread.stop()`等废弃方法\\n- 使用`volatile`保证可见性（但不保证原子性）\\n- 考虑使用`AtomicInteger`等原子类\\n- 日志记录时注意线程安全（如使用`ThreadLocal`存储日志上下文）\\n\\n## 总结\\n多线程是银行系统高并发的基石。通过`synchronized`、`ReentrantLock`、线程池等工具，我们能够安全高效地处理并发事务。下一篇将进入网络编程，学习如何通过Socket通信让银行系统联网。\\n\\n---\\n**下期预告**：第5篇：网络编程——Socket通信与RMI。我们将实现远程银行交易，让客户端通过Socket请求服务端完成操作。\",\"updatedOutline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"updatedState\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\",\"银行账户并发操作（取款、转账）\",\"任务队列（wait/notify）\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\",\"线程创建\",\"synchronized\",\"ReentrantLock\",\"wait/notify\",\"线程池\",\"死锁预防\",\"并发最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，以及多线程并发控制。\"},\"isSeriesComplete\":false},\"seriesState\":\"{\\n  \\\"nextArticle\\\": {\\n    \\\"title\\\": \\\"第4篇：多线程基础——银行系统的并发挑战\\\",\\n    \\\"content\\\": \\\"## 前言\\\\n在前三篇文章中，我们构建了银行系统的稳健基础：异常处理与日志记录确保了错误可控，集合框架优化了数据管理，I/O流实现了文件持久化。然而，现实中的银行系统必须同时服务成千上万的客户——存款、取款、转账并发执行。这就是多线程的舞台。本篇将带你深入Java多线程基础，以银行账户并发操作为实战案例，揭示竞态条件、锁机制与线程协作的奥秘。\\\\n\\\\n## 1. 为什么需要多线程？——银行系统的并发场景\\\\n假设一个银行账户初始余额为1000元。两个线程同时执行取款操作：线程A取800元，线程B取500元。如果没有同步机制，可能出现以下错误流程：\\\\n1. 线程A读取余额1000，判断足够。\\\\n2. 线程B读取余额1000，判断足够。\\\\n3. 线程A扣减800，余额变为200。\\\\n4. 线程B扣减500，余额变为500（实际应为-300，但被覆盖）。\\\\n\\\\n这就是经典的**竞态条件**。多线程编程的核心就是协调线程对共享资源的访问。\\\\n\\\\n## 2. 创建线程的两种方式\\\\n### 2.1 继承Thread类\\\\n```java\\\\npublic class DepositThread extends Thread {\\\\n    private BankAccount account;\\\\n    private double amount;\\\\n    \\\\n    public DepositThread(BankAccount account, double amount) {\\\\n        this.account = account;\\\\n        this.amount = amount;\\\\n    }\\\\n    \\\\n    @Override\\\\n    public void run() {\\\\n        account.deposit(amount);\\\\n    }\\\\n}\\\\n```\\\\n\\\\n### 2.2 实现Runnable接口（推荐）\\\\n```java\\\\npublic class WithdrawTask implements Runnable {\\\\n    private BankAccount account;\\\\n    private double amount;\\\\n    \\\\n    public WithdrawTask(BankAccount account, double amount) {\\\\n        this.account = account;\\\\n        this.amount = amount;\\\\n    }\\\\n    \\\\n    @Override\\\\n    public void run() {\\\\n        account.withdraw(amount);\\\\n    }\\\\n}\\\\n\\\\n// 使用\\\\nThread t = new Thread(new WithdrawTask(account, 500));\\\\nt.start();\\\\n```\\\\n\\\\n## 3. 线程安全问题与synchronized\\\\n### 3.1 问题重现\\\\n```java\\\\npublic class BankAccount {\\\\n    private double balance;\\\\n    \\\\n    public void withdraw(double amount) {\\\\n        if (balance >= amount) {\\\\n            // 模拟网络延迟\\\\n            try { Thread.sleep(10); } catch (InterruptedException e) {}\\\\n            balance -= amount;\\\\n            System.out.println(Thread.currentThread().getName() + \\\\\\\" 取款成功，余额：\\\\\\\" + balance);\\\\n        } else {\\\\n            System.out.println(\\\\\\\"余额不足\\\\\\\");\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n### 3.2 使用synchronized解决\\\\n```java\\\\npublic synchronized void withdraw(double amount) {\\\\n    // 方法体同上\\\\n}\\\\n```\\\\n`synchronized`保证同一时刻只有一个线程能执行该方法。但注意：synchronized会降低并发性能，且可能导致死锁。\\\\n\\\\n## 4. 更细粒度的锁：ReentrantLock\\\\n```java\\\\nimport java.util.concurrent.locks.ReentrantLock;\\\\n\\\\npublic class BankAccount {\\\\n    private double balance;\\\\n    private final ReentrantLock lock = new ReentrantLock();\\\\n    \\\\n    public void withdraw(double amount) {\\\\n        lock.lock();\\\\n        try {\\\\n            if (balance >= amount) {\\\\n                Thread.sleep(10);\\\\n                balance -= amount;\\\\n                System.out.println(Thread.currentThread().getName() + \\\\\\\" 取款成功，余额：\\\\\\\" + balance);\\\\n            } else {\\\\n                System.out.println(\\\\\\\"余额不足\\\\\\\");\\\\n            }\\\\n        } catch (InterruptedException e) {\\\\n            Thread.currentThread().interrupt();\\\\n        } finally {\\\\n            lock.unlock();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\nReentrantLock提供更灵活的锁控制，如可中断锁、公平锁等。\\\\n\\\\n## 5. 线程间协作：wait/notify\\\\n考虑一个场景：多个线程从队列中取任务，队列为空时线程等待，有任务时被唤醒。\\\\n```java\\\\nimport java.util.LinkedList;\\\\nimport java.util.Queue;\\\\n\\\\npublic class TaskQueue {\\\\n    private Queue<String> queue = new LinkedList<>();\\\\n    \\\\n    public synchronized void addTask(String task) {\\\\n        queue.add(task);\\\\n        notifyAll(); // 唤醒等待的线程\\\\n    }\\\\n    \\\\n    public synchronized String getTask() throws InterruptedException {\\\\n        while (queue.isEmpty()) {\\\\n            wait(); // 等待任务\\\\n        }\\\\n        return queue.poll();\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 6. 线程池——管理线程的利器\\\\n手动创建线程开销大，且难以控制数量。使用`ExecutorService`：\\\\n```java\\\\nimport java.util.concurrent.ExecutorService;\\\\nimport java.util.concurrent.Executors;\\\\n\\\\npublic class BankService {\\\\n    private ExecutorService executor = Executors.newFixedThreadPool(10); // 固定10个线程\\\\n    \\\\n    public void processTransaction(Runnable task) {\\\\n        executor.submit(task);\\\\n    }\\\\n    \\\\n    public void shutdown() {\\\\n        executor.shutdown();\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 7. 实战：银行转账系统\\\\n```java\\\\npublic class TransferTask implements Runnable {\\\\n    private BankAccount from;\\\\n    private BankAccount to;\\\\n    private double amount;\\\\n    \\\\n    public TransferTask(BankAccount from, BankAccount to, double amount) {\\\\n        this.from = from;\\\\n        this.to = to;\\\\n        this.amount = amount;\\\\n    }\\\\n    \\\\n    @Override\\\\n    public void run() {\\\\n        // 避免死锁：按账户ID顺序获取锁\\\\n        int fromHash = System.identityHashCode(from);\\\\n        int toHash = System.identityHashCode(to);\\\\n        Object lock1 = fromHash < toHash ? from : to;\\\\n        Object lock2 = fromHash < toHash ? to : from;\\\\n        \\\\n        synchronized (lock1) {\\\\n            synchronized (lock2) {\\\\n                from.withdraw(amount);\\\\n                to.deposit(amount);\\\\n            }\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 8. 线程安全最佳实践\\\\n- 优先使用`java.util.concurrent`包中的并发集合（如`ConcurrentHashMap`）\\\\n- 避免使用`Thread.stop()`等废弃方法\\\\n- 使用`volatile`保证可见性（但不保证原子性）\\\\n- 考虑使用`AtomicInteger`等原子类\\\\n- 日志记录时注意线程安全（如使用`ThreadLocal`存储日志上下文）\\\\n\\\\n## 总结\\\\n多线程是银行系统高并发的基石。通过`synchronized`、`ReentrantLock`、线程池等工具，我们能够安全高效地处理并发事务。下一篇将进入网络编程，学习如何通过Socket通信让银行系统联网。\\\\n\\\\n---\\\\n**下期预告**：第5篇：网络编程——Socket通信与RMI。我们将实现远程银行交易，让客户端通过Socket请求服务端完成操作。\\\",\\n    \\\"updatedOutline\\\": [\\n      \\\"第1篇：异常处理与日志记录——银行系统的稳健之道\\\",\\n      \\\"第2篇：集合框架——从数组到泛型集合的进化\\\",\\n      \\\"第3篇：Java I/O流——文件读写与序列化\\\",\\n      \\\"第4篇：多线程基础——银行系统的并发挑战\\\",\\n      \\\"第5篇：网络编程——Socket通信与RMI\\\",\\n      \\\"第6篇：JDBC与数据库操作——持久化银行数据\\\",\\n      \\\"第7篇：反射与注解——框架的基石\\\",\\n      \\\"第8篇：Lambda表达式与Stream API——函数式编程实战\\\",\\n      \\\"第9篇：设计模式——单例、工厂与观察者\\\",\\n      \\\"第10篇：JVM内存模型与性能调优\\\",\\n      \\\"第11篇：单元测试与Mock——JUnit与Mockito\\\",\\n      \\\"第12篇：构建工具——Maven与Gradle\\\",\\n      \\\"第13篇：版本控制——Git进阶\\\",\\n      \\\"第14篇：Spring基础——依赖注入与AOP\\\",\\n      \\\"第15篇：Spring Boot——快速搭建银行系统\\\",\\n      \\\"第16篇：MyBatis——ORM实战\\\",\\n      \\\"第17篇：RESTful API设计\\\",\\n      \\\"第18篇：微服务入门——Spring Cloud\\\",\\n      \\\"第19篇：Docker容器化部署\\\",\\n      \\\"第20篇：持续集成/持续部署——Jenkins\\\",\\n      \\\"第21篇：消息队列——RabbitMQ与Kafka\\\",\\n      \\\"第22篇：缓存技术——Redis\\\",\\n      \\\"第23篇：搜索引擎——Elasticsearch\\\",\\n      \\\"第24篇：安全机制——认证与授权\\\",\\n      \\\"第25篇：性能测试——JMeter\\\",\\n      \\\"第26篇：日志聚合——ELK Stack\\\",\\n      \\\"第27篇：监控与告警——Prometheus与Grafana\\\",\\n      \\\"第28篇：分布式事务——Seata\\\",\\n      \\\"第29篇：容器编排——Kubernetes\\\",\\n      \\\"第30篇：项目总结——银行系统完整实现\\\"\\n    ],\\n    \\\"updatedState\\\": {\\n      \\\"usedExamples\\\": [\\n        \\\"银行账户系统（异常处理）\\\",\\n        \\\"文件读取（try-with-resources）\\\",\\n        \\\"自定义异常类\\\",\\n        \\\"银行账户并发操作（取款、转账）\\\",\\n        \\\"任务队列（wait/notify）\\\"\\n      ],\\n      \\\"coveredTopics\\\": [\\n        \\\"异常体系\\\",\\n        \\\"try-catch-finally\\\",\\n        \\\"多重捕获\\\",\\n        \\\"try-with-resources\\\",\\n        \\\"自定义异常\\\",\\n        \\\"SLF4J与Logback日志\\\",\\n        \\\"日志级别\\\",\\n        \\\"最佳实践\\\",\\n        \\\"线程创建\\\",\\n        \\\"synchronized\\\",\\n        \\\"ReentrantLock\\\",\\n        \\\"wait/notify\\\",\\n        \\\"线程池\\\",\\n        \\\"死锁预防\\\",\\n        \\\"并发最佳实践\\\"\\n      ],\\n      \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，以及多线程并发控制。\\\"\\n    },\\n    \\\"isSeriesComplete\\\": false\\n  }\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 3, 8, NULL, 'Connect to http://127.0.0.1:8080 failed: Connection refused: getsockopt', '2026-07-08 19:44:38', '2026-07-08 19:26:44', '2026-07-08 19:36:37');
INSERT INTO `ai_webhook_delivery` VALUES (5, 'blog_series_writer-chain-demo01-5', 'blog_series_writer-d213950dea7a41a3a36d7122dbc0ef39', 'blog_series_writer-chain-demo01', 5, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-5\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":5,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-d213950dea7a41a3a36d7122dbc0ef39\",\"context\":{\"outline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"updatedStatus\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\",\"银行服务器-客户端Socket通信\",\"RMI远程账户服务\",\"分布式交易前置机\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\",\"Socket通信\",\"TCP服务器/客户端\",\"序列化对象传输\",\"RMI远程接口\",\"RMI注册表\",\"分布式架构基础\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，逐步深入网络编程\"},\"seriesComplete\":false,\"prevSeq\":4,\"topic\":\"30天Java进阶\",\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"article\":{\"title\":\"第5篇：网络编程——Socket通信与RMI\",\"content\":\"## 引言\\n在银行系统中，网络编程是实现分布式服务的关键。第4篇我们探讨了多线程并发，而网络通信让不同节点（如分行系统、ATM机、核心服务器）之间能够交换数据。本篇将深入Socket通信和远程方法调用（RMI），并结合银行系统的实际场景——如ATM交易请求、远程账户查询——展示如何构建可靠的网络交互。\\n\\n## 1. Socket通信基础\\nSocket是网络通信的端点，Java通过`java.net`包提供TCP和UDP支持。银行系统通常使用TCP保证数据可靠性。\\n\\n### 1.1 简单的银行服务器-客户端\\n**服务器端（BankServer）**：监听端口，处理客户请求。\\n```java\\nimport java.io.*;\\nimport java.net.*;\\n\\npublic class BankServer {\\n    public static void main(String[] args) {\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\n            System.out.println(\\\"银行服务器启动，端口：8080\\\");\\n            while (true) {\\n                Socket clientSocket = serverSocket.accept();\\n                // 每个客户端由独立线程处理，避免阻塞\\n                new Thread(new ClientHandler(clientSocket)).start();\\n            }\\n        } catch (IOException e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n\\nclass ClientHandler implements Runnable {\\n    private Socket socket;\\n    public ClientHandler(Socket socket) { this.socket = socket; }\\n\\n    @Override\\n    public void run() {\\n        try (BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()));\\n             PrintWriter out = new PrintWriter(socket.getOutputStream(), true)) {\\n            String request = in.readLine();\\n            System.out.println(\\\"收到请求：\\\" + request);\\n            // 模拟处理：查询余额\\n            String response = \\\"余额：10000.00\\\";\\n            out.println(response);\\n        } catch (IOException e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n```\\n**客户端（ATMClient）**：连接服务器并发送请求。\\n```java\\nimport java.io.*;\\nimport java.net.*;\\n\\npublic class ATMClient {\\n    public static void main(String[] args) {\\n        try (Socket socket = new Socket(\\\"localhost\\\", 8080);\\n             PrintWriter out = new PrintWriter(socket.getOutputStream(), true);\\n             BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()))) {\\n            out.println(\\\"查询余额\\\");\\n            String response = in.readLine();\\n            System.out.println(\\\"服务器响应：\\\" + response);\\n        } catch (IOException e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n```\\n**关键点**：\\n- 使用`ServerSocket`监听，`Socket`通信。\\n- 每个客户端启动新线程处理，防止阻塞主线程（结合第4篇多线程知识）。\\n- 使用`BufferedReader`和`PrintWriter`简化文本读写。\\n\\n### 1.2 处理复杂协议\\n银行系统通常需要结构化请求，例如JSON格式。我们可以使用`ObjectInputStream`/`ObjectOutputStream`传输序列化对象（参考第3篇序列化）。\\n\\n**序列化请求对象**：\\n```java\\nimport java.io.Serializable;\\n\\npublic class TransactionRequest implements Serializable {\\n    private static final long serialVersionUID = 1L;\\n    private String accountId;\\n    private double amount;\\n    private String type; // \\\"DEPOSIT\\\", \\\"WITHDRAW\\\"\\n    // getters/setters\\n}\\n```\\n服务器端接收对象：\\n```java\\nObjectInputStream ois = new ObjectInputStream(socket.getInputStream());\\nTransactionRequest request = (TransactionRequest) ois.readObject();\\n```\\n\\n## 2. RMI——远程方法调用\\nRMI让Java对象在不同JVM间透明调用，适合银行系统的远程服务（如远程账户管理）。\\n\\n### 2.1 定义远程接口\\n```java\\nimport java.rmi.Remote;\\nimport java.rmi.RemoteException;\\n\\npublic interface BankAccountService extends Remote {\\n    double getBalance(String accountId) throws RemoteException;\\n    void deposit(String accountId, double amount) throws RemoteException;\\n}\\n```\\n### 2.2 实现远程对象\\n```java\\nimport java.rmi.server.UnicastRemoteObject;\\nimport java.rmi.RemoteException;\\nimport java.util.HashMap;\\nimport java.util.Map;\\n\\npublic class BankAccountServiceImpl extends UnicastRemoteObject implements BankAccountService {\\n    private Map<String, Double> accounts = new HashMap<>();\\n\\n    protected BankAccountServiceImpl() throws RemoteException {\\n        super();\\n        accounts.put(\\\"1001\\\", 5000.0);\\n        accounts.put(\\\"1002\\\", 10000.0);\\n    }\\n\\n    @Override\\n    public double getBalance(String accountId) throws RemoteException {\\n        return accounts.getOrDefault(accountId, 0.0);\\n    }\\n\\n    @Override\\n    public void deposit(String accountId, double amount) throws RemoteException {\\n        accounts.merge(accountId, amount, Double::sum);\\n    }\\n}\\n```\\n### 2.3 启动RMI注册表并绑定服务\\n```java\\nimport java.rmi.registry.LocateRegistry;\\nimport java.rmi.registry.Registry;\\n\\npublic class RMIServer {\\n    public static void main(String[] args) {\\n        try {\\n            BankAccountService service = new BankAccountServiceImpl();\\n            Registry registry = LocateRegistry.createRegistry(1099);\\n            registry.rebind(\\\"BankAccountService\\\", service);\\n            System.out.println(\\\"RMI服务已启动\\\");\\n        } catch (Exception e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n```\\n### 2.4 客户端调用\\n```java\\nimport java.rmi.registry.LocateRegistry;\\nimport java.rmi.registry.Registry;\\n\\npublic class RMIClient {\\n    public static void main(String[] args) {\\n        try {\\n            Registry registry = LocateRegistry.getRegistry(\\\"localhost\\\", 1099);\\n            BankAccountService service = (BankAccountService) registry.lookup(\\\"BankAccountService\\\");\\n            double balance = service.getBalance(\\\"1001\\\");\\n            System.out.println(\\\"账户1001余额：\\\" + balance);\\n            service.deposit(\\\"1001\\\", 500);\\n            System.out.println(\\\"存款后余额：\\\" + service.getBalance(\\\"1001\\\"));\\n        } catch (Exception e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n```\\n**RMI注意事项**：\\n- 远程对象必须实现`Remote`接口，方法抛出`RemoteException`。\\n- 客户端需要访问远程接口的stub类，通常通过RMI注册表获取。\\n- 序列化对象（如账户ID）需实现`Serializable`。\\n\\n## 3. 银行系统实战：分布式交易处理\\n结合Socket和RMI，我们可以构建一个简单的分布式银行系统：\\n- **ATM客户端**：使用Socket发送交易请求到前置机。\\n- **前置机**：接收请求，通过RMI调用核心银行服务。\\n- **核心银行服务**：处理账户操作。\\n\\n**前置机代码示例**：\\n```java\\nimport java.io.*;\\nimport java.net.*;\\nimport java.rmi.registry.LocateRegistry;\\nimport java.rmi.registry.Registry;\\n\\npublic class FrontEndServer {\\n    public static void main(String[] args) {\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\n            Registry registry = LocateRegistry.getRegistry(\\\"corebank\\\", 1099);\\n            BankAccountService bankService = (BankAccountService) registry.lookup(\\\"BankAccountService\\\");\\n\\n            while (true) {\\n                Socket clientSocket = serverSocket.accept();\\n                new Thread(() -> {\\n                    try (BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));\\n                         PrintWriter out = new PrintWriter(clientSocket.getOutputStream(), true)) {\\n                        String request = in.readLine();\\n                        // 解析请求，例如 \\\"DEPOSIT:1001:500\\\"\\n                        String[] parts = request.split(\\\":\\\");\\n                        if (\\\"DEPOSIT\\\".equals(parts[0])) {\\n                            bankService.deposit(parts[1], Double.parseDouble(parts[2]));\\n                            out.println(\\\"成功\\\");\\n                        } else if (\\\"BALANCE\\\".equals(parts[0])) {\\n                            double balance = bankService.getBalance(parts[1]);\\n                            out.println(\\\"余额：\\\" + balance);\\n                        }\\n                    } catch (Exception e) {\\n                        e.printStackTrace();\\n                    }\\n                }).start();\\n            }\\n        } catch (Exception e) {\\n            e.printStackTrace();\\n        }\\n    }\\n}\\n```\\n\\n## 4. 异常处理与日志记录\\n网络编程中异常频繁（连接超时、IO异常），结合第1篇的日志记录：\\n```java\\nimport org.slf4j.Logger;\\nimport org.slf4j.LoggerFactory;\\n\\npublic class BankServer {\\n    private static final Logger logger = LoggerFactory.getLogger(BankServer.class);\\n\\n    public static void main(String[] args) {\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\n            logger.info(\\\"银行服务器启动，端口：8080\\\");\\n            while (true) {\\n                Socket clientSocket = serverSocket.accept();\\n                logger.debug(\\\"新客户端连接：{}\\\", clientSocket.getInetAddress());\\n                new Thread(new ClientHandler(clientSocket)).start();\\n            }\\n        } catch (IOException e) {\\n            logger.error(\\\"服务器启动失败\\\", e);\\n        }\\n    }\\n}\\n```\\n\\n## 总结\\n本篇通过Socket通信和RMI，展示了银行系统网络编程的核心技术。Socket适用于低层次、自定义协议的场景，而RMI则简化了分布式对象调用。实际项目中，更常用HTTP/REST（后续Spring Boot篇）或消息队列（第21篇），但理解底层原理至关重要。\\n\\n**下篇预告**：第6篇将进入JDBC与数据库操作，实现银行数据的持久化存储。\",\"examples\":[\"银行服务器-客户端Socket通信\",\"RMI远程账户服务\",\"分布式交易前置机\"],\"coveredTopics\":[\"Socket通信\",\"TCP服务器/客户端\",\"序列化对象传输\",\"RMI远程接口\",\"RMI注册表\",\"分布式架构基础\"],\"style\":\"实战驱动，结合银行系统示例，强调网络编程的异常处理和日志记录\"},\"seriesState\":\"{\\n  \\\"article\\\": {\\n    \\\"title\\\": \\\"第5篇：网络编程——Socket通信与RMI\\\",\\n    \\\"content\\\": \\\"## 引言\\\\n在银行系统中，网络编程是实现分布式服务的关键。第4篇我们探讨了多线程并发，而网络通信让不同节点（如分行系统、ATM机、核心服务器）之间能够交换数据。本篇将深入Socket通信和远程方法调用（RMI），并结合银行系统的实际场景——如ATM交易请求、远程账户查询——展示如何构建可靠的网络交互。\\\\n\\\\n## 1. Socket通信基础\\\\nSocket是网络通信的端点，Java通过`java.net`包提供TCP和UDP支持。银行系统通常使用TCP保证数据可靠性。\\\\n\\\\n### 1.1 简单的银行服务器-客户端\\\\n**服务器端（BankServer）**：监听端口，处理客户请求。\\\\n```java\\\\nimport java.io.*;\\\\nimport java.net.*;\\\\n\\\\npublic class BankServer {\\\\n    public static void main(String[] args) {\\\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\\\n            System.out.println(\\\\\\\"银行服务器启动，端口：8080\\\\\\\");\\\\n            while (true) {\\\\n                Socket clientSocket = serverSocket.accept();\\\\n                // 每个客户端由独立线程处理，避免阻塞\\\\n                new Thread(new ClientHandler(clientSocket)).start();\\\\n            }\\\\n        } catch (IOException e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n\\\\nclass ClientHandler implements Runnable {\\\\n    private Socket socket;\\\\n    public ClientHandler(Socket socket) { this.socket = socket; }\\\\n\\\\n    @Override\\\\n    public void run() {\\\\n        try (BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()));\\\\n             PrintWriter out = new PrintWriter(socket.getOutputStream(), true)) {\\\\n            String request = in.readLine();\\\\n            System.out.println(\\\\\\\"收到请求：\\\\\\\" + request);\\\\n            // 模拟处理：查询余额\\\\n            String response = \\\\\\\"余额：10000.00\\\\\\\";\\\\n            out.println(response);\\\\n        } catch (IOException e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n**客户端（ATMClient）**：连接服务器并发送请求。\\\\n```java\\\\nimport java.io.*;\\\\nimport java.net.*;\\\\n\\\\npublic class ATMClient {\\\\n    public static void main(String[] args) {\\\\n        try (Socket socket = new Socket(\\\\\\\"localhost\\\\\\\", 8080);\\\\n             PrintWriter out = new PrintWriter(socket.getOutputStream(), true);\\\\n             BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()))) {\\\\n            out.println(\\\\\\\"查询余额\\\\\\\");\\\\n            String response = in.readLine();\\\\n            System.out.println(\\\\\\\"服务器响应：\\\\\\\" + response);\\\\n        } catch (IOException e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n**关键点**：\\\\n- 使用`ServerSocket`监听，`Socket`通信。\\\\n- 每个客户端启动新线程处理，防止阻塞主线程（结合第4篇多线程知识）。\\\\n- 使用`BufferedReader`和`PrintWriter`简化文本读写。\\\\n\\\\n### 1.2 处理复杂协议\\\\n银行系统通常需要结构化请求，例如JSON格式。我们可以使用`ObjectInputStream`/`ObjectOutputStream`传输序列化对象（参考第3篇序列化）。\\\\n\\\\n**序列化请求对象**：\\\\n```java\\\\nimport java.io.Serializable;\\\\n\\\\npublic class TransactionRequest implements Serializable {\\\\n    private static final long serialVersionUID = 1L;\\\\n    private String accountId;\\\\n    private double amount;\\\\n    private String type; // \\\\\\\"DEPOSIT\\\\\\\", \\\\\\\"WITHDRAW\\\\\\\"\\\\n    // getters/setters\\\\n}\\\\n```\\\\n服务器端接收对象：\\\\n```java\\\\nObjectInputStream ois = new ObjectInputStream(socket.getInputStream());\\\\nTransactionRequest request = (TransactionRequest) ois.readObject();\\\\n```\\\\n\\\\n## 2. RMI——远程方法调用\\\\nRMI让Java对象在不同JVM间透明调用，适合银行系统的远程服务（如远程账户管理）。\\\\n\\\\n### 2.1 定义远程接口\\\\n```java\\\\nimport java.rmi.Remote;\\\\nimport java.rmi.RemoteException;\\\\n\\\\npublic interface BankAccountService extends Remote {\\\\n    double getBalance(String accountId) throws RemoteException;\\\\n    void deposit(String accountId, double amount) throws RemoteException;\\\\n}\\\\n```\\\\n### 2.2 实现远程对象\\\\n```java\\\\nimport java.rmi.server.UnicastRemoteObject;\\\\nimport java.rmi.RemoteException;\\\\nimport java.util.HashMap;\\\\nimport java.util.Map;\\\\n\\\\npublic class BankAccountServiceImpl extends UnicastRemoteObject implements BankAccountService {\\\\n    private Map<String, Double> accounts = new HashMap<>();\\\\n\\\\n    protected BankAccountServiceImpl() throws RemoteException {\\\\n        super();\\\\n        accounts.put(\\\\\\\"1001\\\\\\\", 5000.0);\\\\n        accounts.put(\\\\\\\"1002\\\\\\\", 10000.0);\\\\n    }\\\\n\\\\n    @Override\\\\n    public double getBalance(String accountId) throws RemoteException {\\\\n        return accounts.getOrDefault(accountId, 0.0);\\\\n    }\\\\n\\\\n    @Override\\\\n    public void deposit(String accountId, double amount) throws RemoteException {\\\\n        accounts.merge(accountId, amount, Double::sum);\\\\n    }\\\\n}\\\\n```\\\\n### 2.3 启动RMI注册表并绑定服务\\\\n```java\\\\nimport java.rmi.registry.LocateRegistry;\\\\nimport java.rmi.registry.Registry;\\\\n\\\\npublic class RMIServer {\\\\n    public static void main(String[] args) {\\\\n        try {\\\\n            BankAccountService service = new BankAccountServiceImpl();\\\\n            Registry registry = LocateRegistry.createRegistry(1099);\\\\n            registry.rebind(\\\\\\\"BankAccountService\\\\\\\", service);\\\\n            System.out.println(\\\\\\\"RMI服务已启动\\\\\\\");\\\\n        } catch (Exception e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n### 2.4 客户端调用\\\\n```java\\\\nimport java.rmi.registry.LocateRegistry;\\\\nimport java.rmi.registry.Registry;\\\\n\\\\npublic class RMIClient {\\\\n    public static void main(String[] args) {\\\\n        try {\\\\n            Registry registry = LocateRegistry.getRegistry(\\\\\\\"localhost\\\\\\\", 1099);\\\\n            BankAccountService service = (BankAccountService) registry.lookup(\\\\\\\"BankAccountService\\\\\\\");\\\\n            double balance = service.getBalance(\\\\\\\"1001\\\\\\\");\\\\n            System.out.println(\\\\\\\"账户1001余额：\\\\\\\" + balance);\\\\n            service.deposit(\\\\\\\"1001\\\\\\\", 500);\\\\n            System.out.println(\\\\\\\"存款后余额：\\\\\\\" + service.getBalance(\\\\\\\"1001\\\\\\\"));\\\\n        } catch (Exception e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n**RMI注意事项**：\\\\n- 远程对象必须实现`Remote`接口，方法抛出`RemoteException`。\\\\n- 客户端需要访问远程接口的stub类，通常通过RMI注册表获取。\\\\n- 序列化对象（如账户ID）需实现`Serializable`。\\\\n\\\\n## 3. 银行系统实战：分布式交易处理\\\\n结合Socket和RMI，我们可以构建一个简单的分布式银行系统：\\\\n- **ATM客户端**：使用Socket发送交易请求到前置机。\\\\n- **前置机**：接收请求，通过RMI调用核心银行服务。\\\\n- **核心银行服务**：处理账户操作。\\\\n\\\\n**前置机代码示例**：\\\\n```java\\\\nimport java.io.*;\\\\nimport java.net.*;\\\\nimport java.rmi.registry.LocateRegistry;\\\\nimport java.rmi.registry.Registry;\\\\n\\\\npublic class FrontEndServer {\\\\n    public static void main(String[] args) {\\\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\\\n            Registry registry = LocateRegistry.getRegistry(\\\\\\\"corebank\\\\\\\", 1099);\\\\n            BankAccountService bankService = (BankAccountService) registry.lookup(\\\\\\\"BankAccountService\\\\\\\");\\\\n\\\\n            while (true) {\\\\n                Socket clientSocket = serverSocket.accept();\\\\n                new Thread(() -> {\\\\n                    try (BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));\\\\n                         PrintWriter out = new PrintWriter(clientSocket.getOutputStream(), true)) {\\\\n                        String request = in.readLine();\\\\n                        // 解析请求，例如 \\\\\\\"DEPOSIT:1001:500\\\\\\\"\\\\n                        String[] parts = request.split(\\\\\\\":\\\\\\\");\\\\n                        if (\\\\\\\"DEPOSIT\\\\\\\".equals(parts[0])) {\\\\n                            bankService.deposit(parts[1], Double.parseDouble(parts[2]));\\\\n                            out.println(\\\\\\\"成功\\\\\\\");\\\\n                        } else if (\\\\\\\"BALANCE\\\\\\\".equals(parts[0])) {\\\\n                            double balance = bankService.getBalance(parts[1]);\\\\n                            out.println(\\\\\\\"余额：\\\\\\\" + balance);\\\\n                        }\\\\n                    } catch (Exception e) {\\\\n                        e.printStackTrace();\\\\n                    }\\\\n                }).start();\\\\n            }\\\\n        } catch (Exception e) {\\\\n            e.printStackTrace();\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 4. 异常处理与日志记录\\\\n网络编程中异常频繁（连接超时、IO异常），结合第1篇的日志记录：\\\\n```java\\\\nimport org.slf4j.Logger;\\\\nimport org.slf4j.LoggerFactory;\\\\n\\\\npublic class BankServer {\\\\n    private static final Logger logger = LoggerFactory.getLogger(BankServer.class);\\\\n\\\\n    public static void main(String[] args) {\\\\n        try (ServerSocket serverSocket = new ServerSocket(8080)) {\\\\n            logger.info(\\\\\\\"银行服务器启动，端口：8080\\\\\\\");\\\\n            while (true) {\\\\n                Socket clientSocket = serverSocket.accept();\\\\n                logger.debug(\\\\\\\"新客户端连接：{}\\\\\\\", clientSocket.getInetAddress());\\\\n                new Thread(new ClientHandler(clientSocket)).start();\\\\n            }\\\\n        } catch (IOException e) {\\\\n            logger.error(\\\\\\\"服务器启动失败\\\\\\\", e);\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n## 总结\\\\n本篇通过Socket通信和RMI，展示了银行系统网络编程的核心技术。Socket适用于低层次、自定义协议的场景，而RMI则简化了分布式对象调用。实际项目中，更常用HTTP/REST（后续Spring Boot篇）或消息队列（第21篇），但理解底层原理至关重要。\\\\n\\\\n**下篇预告**：第6篇将进入JDBC与数据库操作，实现银行数据的持久化存储。\\\",\\n    \\\"examples\\\": [\\\"银行服务器-客户端Socket通信\\\", \\\"RMI远程账户服务\\\", \\\"分布式交易前置机\\\"],\\n    \\\"coveredTopics\\\": [\\\"Socket通信\\\", \\\"TCP服务器/客户端\\\", \\\"序列化对象传输\\\", \\\"RMI远程接口\\\", \\\"RMI注册表\\\", \\\"分布式架构基础\\\"],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调网络编程的异常处理和日志记录\\\"\\n  },\\n  \\\"updatedStatus\\\": {\\n    \\\"usedExamples\\\": [\\\"银行账户系统（异常处理）\\\", \\\"文件读取（try-with-resources）\\\", \\\"自定义异常类\\\", \\\"银行服务器-客户端Socket通信\\\", \\\"RMI远程账户服务\\\", \\\"分布式交易前置机\\\"],\\n    \\\"coveredTopics\\\": [\\\"异常体系\\\", \\\"try-catch-finally\\\", \\\"多重捕获\\\", \\\"try-with-resources\\\", \\\"自定义异常\\\", \\\"SLF4J与Logback日志\\\", \\\"日志级别\\\", \\\"最佳实践\\\", \\\"Socket通信\\\", \\\"TCP服务器/客户端\\\", \\\"序列化对象传输\\\", \\\"RMI远程接口\\\", \\\"RMI注册表\\\", \\\"分布式架构基础\\\"],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践，逐步深入网络编程\\\"\\n  },\\n  \\\"seriesComplete\\\": false\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 2, 8, NULL, 'Connect to http://127.0.0.1:8080 failed: Connection refused: getsockopt', '2026-07-08 19:37:51', '2026-07-08 19:28:51', '2026-07-08 19:36:13');
INSERT INTO `ai_webhook_delivery` VALUES (6, 'blog_series_writer-chain-demo01-6', 'blog_series_writer-a8729d85f80246579e6538ce2055286a', 'blog_series_writer-chain-demo01', 6, 'blog_series_writer', NULL, 'ITERATION_ADVANCED', 'http://127.0.0.1:8082/blog/admin/blog/webhook/series-append', 'INLINE', '{\"deliveryId\":\"blog_series_writer-chain-demo01-6\",\"event\":\"ITERATION_ADVANCED\",\"chainId\":\"blog_series_writer-chain-demo01\",\"seq\":6,\"agentCode\":\"blog_series_writer\",\"instanceId\":\"blog_series_writer-a8729d85f80246579e6538ce2055286a\",\"context\":{\"updatedState\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\",\"连接MySQL数据库\",\"插入账户（PreparedStatement）\",\"转账方法（事务管理）\",\"HikariCP连接池配置\",\"AccountDAO接口与实现\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\",\"JDBC核心步骤\",\"PreparedStatement\",\"事务管理（commit/rollback）\",\"连接池（HikariCP）\",\"DAO模式\"],\"style\":\"实战驱动，结合银行系统示例，强调事务一致性和连接池优化。\"},\"outline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"prevSeq\":5,\"isSeriesComplete\":false,\"updatedOutline\":[\"第1篇：异常处理与日志记录——银行系统的稳健之道\",\"第2篇：集合框架——从数组到泛型集合的进化\",\"第3篇：Java I/O流——文件读写与序列化\",\"第4篇：多线程基础——银行系统的并发挑战\",\"第5篇：网络编程——Socket通信与RMI\",\"第6篇：JDBC与数据库操作——持久化银行数据\",\"第7篇：反射与注解——框架的基石\",\"第8篇：Lambda表达式与Stream API——函数式编程实战\",\"第9篇：设计模式——单例、工厂与观察者\",\"第10篇：JVM内存模型与性能调优\",\"第11篇：单元测试与Mock——JUnit与Mockito\",\"第12篇：构建工具——Maven与Gradle\",\"第13篇：版本控制——Git进阶\",\"第14篇：Spring基础——依赖注入与AOP\",\"第15篇：Spring Boot——快速搭建银行系统\",\"第16篇：MyBatis——ORM实战\",\"第17篇：RESTful API设计\",\"第18篇：微服务入门——Spring Cloud\",\"第19篇：Docker容器化部署\",\"第20篇：持续集成/持续部署——Jenkins\",\"第21篇：消息队列——RabbitMQ与Kafka\",\"第22篇：缓存技术——Redis\",\"第23篇：搜索引擎——Elasticsearch\",\"第24篇：安全机制——认证与授权\",\"第25篇：性能测试——JMeter\",\"第26篇：日志聚合——ELK Stack\",\"第27篇：监控与告警——Prometheus与Grafana\",\"第28篇：分布式事务——Seata\",\"第29篇：容器编排——Kubernetes\",\"第30篇：项目总结——银行系统完整实现\"],\"topic\":\"30天Java进阶\",\"accumulated\":{\"usedExamples\":[\"银行账户系统（异常处理）\",\"文件读取（try-with-resources）\",\"自定义异常类\"],\"coveredTopics\":[\"异常体系\",\"try-catch-finally\",\"多重捕获\",\"try-with-resources\",\"自定义异常\",\"SLF4J与Logback日志\",\"日志级别\",\"最佳实践\"],\"style\":\"实战驱动，结合银行系统示例，强调异常处理与日志记录的最佳实践。\"},\"nextArticle\":{\"title\":\"第6篇：JDBC与数据库操作——持久化银行数据\",\"content\":\"## 第6篇：JDBC与数据库操作——持久化银行数据\\n\\n在前几篇中，我们构建了银行系统的异常处理、集合、I/O、多线程和网络通信。但所有数据都存储在内存中，系统重启后数据丢失。今天，我们通过JDBC（Java Database Connectivity）将银行账户数据持久化到关系型数据库中，实现数据的可靠存储与查询。\\n\\n### 1. JDBC基础\\nJDBC是Java访问数据库的标准API。核心步骤：加载驱动、建立连接、执行SQL、处理结果、关闭资源。\\n\\n#### 示例：连接MySQL数据库\\n```java\\n// 1. 加载驱动（MySQL 8+可省略）\\nClass.forName(\\\"com.mysql.cj.jdbc.Driver\\\");\\n\\n// 2. 建立连接\\nString url = \\\"jdbc:mysql://localhost:3306/bank_db\\\";\\nString user = \\\"root\\\";\\nString password = \\\"123456\\\";\\ntry (Connection conn = DriverManager.getConnection(url, user, password)) {\\n    System.out.println(\\\"连接成功！\\\");\\n} catch (SQLException e) {\\n    e.printStackTrace();\\n}\\n```\\n\\n### 2. 使用Statement与PreparedStatement\\n`Statement`用于执行静态SQL，`PreparedStatement`预编译并防止SQL注入，推荐使用后者。\\n\\n#### 示例：创建账户表\\n```sql\\nCREATE TABLE accounts (\\n    id INT AUTO_INCREMENT PRIMARY KEY,\\n    account_no VARCHAR(20) UNIQUE NOT NULL,\\n    holder_name VARCHAR(50) NOT NULL,\\n    balance DECIMAL(10,2) DEFAULT 0.00\\n);\\n```\\n\\n#### Java代码：插入账户（PreparedStatement）\\n```java\\nString sql = \\\"INSERT INTO accounts (account_no, holder_name, balance) VALUES (?, ?, ?)\\\";\\ntry (Connection conn = DriverManager.getConnection(url, user, password);\\n     PreparedStatement pstmt = conn.prepareStatement(sql)) {\\n    pstmt.setString(1, \\\"ACC1001\\\");\\n    pstmt.setString(2, \\\"张三\\\");\\n    pstmt.setBigDecimal(3, new BigDecimal(\\\"1000.00\\\"));\\n    int rows = pstmt.executeUpdate();\\n    System.out.println(\\\"插入成功，影响行数：\\\" + rows);\\n} catch (SQLException e) {\\n    e.printStackTrace();\\n}\\n```\\n\\n### 3. 事务管理：银行转账的原子性\\n转账操作需要保证一致性：扣款和存款要么都成功，要么都回滚。JDBC通过`setAutoCommit(false)`、`commit()`和`rollback()`实现。\\n\\n#### 示例：转账方法\\n```java\\npublic void transfer(String fromAccount, String toAccount, BigDecimal amount) throws SQLException {\\n    String sqlDebit = \\\"UPDATE accounts SET balance = balance - ? WHERE account_no = ? AND balance >= ?\\\";\\n    String sqlCredit = \\\"UPDATE accounts SET balance = balance + ? WHERE account_no = ?\\\";\\n    \\n    try (Connection conn = dataSource.getConnection()) {\\n        conn.setAutoCommit(false);\\n        try (PreparedStatement debitStmt = conn.prepareStatement(sqlDebit);\\n             PreparedStatement creditStmt = conn.prepareStatement(sqlCredit)) {\\n            \\n            // 扣款\\n            debitStmt.setBigDecimal(1, amount);\\n            debitStmt.setString(2, fromAccount);\\n            debitStmt.setBigDecimal(3, amount);\\n            int rows = debitStmt.executeUpdate();\\n            if (rows == 0) throw new SQLException(\\\"账户余额不足或账户不存在\\\");\\n            \\n            // 存款\\n            creditStmt.setBigDecimal(1, amount);\\n            creditStmt.setString(2, toAccount);\\n            creditStmt.executeUpdate();\\n            \\n            conn.commit();\\n        } catch (SQLException e) {\\n            conn.rollback();\\n            throw e;\\n        }\\n    }\\n}\\n```\\n\\n### 4. 连接池：提高性能\\n每次操作都创建连接开销大，使用连接池（如HikariCP）复用连接。\\n\\n#### 配置HikariCP（Maven依赖）\\n```xml\\n<dependency>\\n    <groupId>com.zaxxer</groupId>\\n    <artifactId>HikariCP</artifactId>\\n    <version>5.0.1</version>\\n</dependency>\\n```\\n\\n#### 使用示例\\n```java\\nHikariConfig config = new HikariConfig();\\nconfig.setJdbcUrl(url);\\nconfig.setUsername(user);\\nconfig.setPassword(password);\\nconfig.setMaximumPoolSize(10);\\nHikariDataSource dataSource = new HikariDataSource(config);\\n\\n// 获取连接\\ntry (Connection conn = dataSource.getConnection()) {\\n    // 操作数据库\\n}\\n```\\n\\n### 5. 结合银行系统：DAO模式\\n使用DAO（Data Access Object）模式分离数据访问逻辑。\\n\\n#### AccountDAO接口\\n```java\\npublic interface AccountDAO {\\n    void insert(Account account) throws SQLException;\\n    Account findByAccountNo(String accountNo) throws SQLException;\\n    void updateBalance(String accountNo, BigDecimal newBalance) throws SQLException;\\n    List<Account> findAll() throws SQLException;\\n}\\n```\\n\\n#### 实现类AccountDAOImpl\\n```java\\npublic class AccountDAOImpl implements AccountDAO {\\n    private final DataSource dataSource;\\n    \\n    public AccountDAOImpl(DataSource dataSource) {\\n        this.dataSource = dataSource;\\n    }\\n    \\n    @Override\\n    public Account findByAccountNo(String accountNo) throws SQLException {\\n        String sql = \\\"SELECT * FROM accounts WHERE account_no = ?\\\";\\n        try (Connection conn = dataSource.getConnection();\\n             PreparedStatement pstmt = conn.prepareStatement(sql)) {\\n            pstmt.setString(1, accountNo);\\n            try (ResultSet rs = pstmt.executeQuery()) {\\n                if (rs.next()) {\\n                    return new Account(\\n                        rs.getInt(\\\"id\\\"),\\n                        rs.getString(\\\"account_no\\\"),\\n                        rs.getString(\\\"holder_name\\\"),\\n                        rs.getBigDecimal(\\\"balance\\\")\\n                    );\\n                }\\n                return null;\\n            }\\n        }\\n    }\\n    // 其他方法类似...\\n}\\n```\\n\\n### 6. 最佳实践\\n- **使用PreparedStatement**：防止SQL注入。\\n- **使用连接池**：避免频繁创建连接。\\n- **事务管理**：确保数据一致性，尤其是转账等操作。\\n- **资源关闭**：使用try-with-resources自动关闭Connection、Statement、ResultSet。\\n- **异常处理**：捕获SQLException并记录日志。\\n\\n### 总结\\n今天我们学习了JDBC的核心操作，包括连接、增删改查、事务和连接池。结合银行系统，我们实现了账户数据的持久化。下一篇将深入反射与注解，揭示框架的底层原理。\\n\\n**课后练习**：为银行系统实现一个完整的账户管理模块，包括开户、查询、转账，并使用HikariCP连接池。\",\"examples\":[\"连接MySQL数据库\",\"插入账户（PreparedStatement）\",\"转账方法（事务管理）\",\"HikariCP连接池配置\",\"AccountDAO接口与实现\"],\"coveredTopics\":[\"JDBC核心步骤\",\"PreparedStatement\",\"事务管理（commit/rollback）\",\"连接池（HikariCP）\",\"DAO模式\"],\"style\":\"实战驱动，结合银行系统示例，强调事务一致性和连接池优化。\"},\"seriesState\":\"{\\n  \\\"nextArticle\\\": {\\n    \\\"title\\\": \\\"第6篇：JDBC与数据库操作——持久化银行数据\\\",\\n    \\\"content\\\": \\\"## 第6篇：JDBC与数据库操作——持久化银行数据\\\\n\\\\n在前几篇中，我们构建了银行系统的异常处理、集合、I/O、多线程和网络通信。但所有数据都存储在内存中，系统重启后数据丢失。今天，我们通过JDBC（Java Database Connectivity）将银行账户数据持久化到关系型数据库中，实现数据的可靠存储与查询。\\\\n\\\\n### 1. JDBC基础\\\\nJDBC是Java访问数据库的标准API。核心步骤：加载驱动、建立连接、执行SQL、处理结果、关闭资源。\\\\n\\\\n#### 示例：连接MySQL数据库\\\\n```java\\\\n// 1. 加载驱动（MySQL 8+可省略）\\\\nClass.forName(\\\\\\\"com.mysql.cj.jdbc.Driver\\\\\\\");\\\\n\\\\n// 2. 建立连接\\\\nString url = \\\\\\\"jdbc:mysql://localhost:3306/bank_db\\\\\\\";\\\\nString user = \\\\\\\"root\\\\\\\";\\\\nString password = \\\\\\\"123456\\\\\\\";\\\\ntry (Connection conn = DriverManager.getConnection(url, user, password)) {\\\\n    System.out.println(\\\\\\\"连接成功！\\\\\\\");\\\\n} catch (SQLException e) {\\\\n    e.printStackTrace();\\\\n}\\\\n```\\\\n\\\\n### 2. 使用Statement与PreparedStatement\\\\n`Statement`用于执行静态SQL，`PreparedStatement`预编译并防止SQL注入，推荐使用后者。\\\\n\\\\n#### 示例：创建账户表\\\\n```sql\\\\nCREATE TABLE accounts (\\\\n    id INT AUTO_INCREMENT PRIMARY KEY,\\\\n    account_no VARCHAR(20) UNIQUE NOT NULL,\\\\n    holder_name VARCHAR(50) NOT NULL,\\\\n    balance DECIMAL(10,2) DEFAULT 0.00\\\\n);\\\\n```\\\\n\\\\n#### Java代码：插入账户（PreparedStatement）\\\\n```java\\\\nString sql = \\\\\\\"INSERT INTO accounts (account_no, holder_name, balance) VALUES (?, ?, ?)\\\\\\\";\\\\ntry (Connection conn = DriverManager.getConnection(url, user, password);\\\\n     PreparedStatement pstmt = conn.prepareStatement(sql)) {\\\\n    pstmt.setString(1, \\\\\\\"ACC1001\\\\\\\");\\\\n    pstmt.setString(2, \\\\\\\"张三\\\\\\\");\\\\n    pstmt.setBigDecimal(3, new BigDecimal(\\\\\\\"1000.00\\\\\\\"));\\\\n    int rows = pstmt.executeUpdate();\\\\n    System.out.println(\\\\\\\"插入成功，影响行数：\\\\\\\" + rows);\\\\n} catch (SQLException e) {\\\\n    e.printStackTrace();\\\\n}\\\\n```\\\\n\\\\n### 3. 事务管理：银行转账的原子性\\\\n转账操作需要保证一致性：扣款和存款要么都成功，要么都回滚。JDBC通过`setAutoCommit(false)`、`commit()`和`rollback()`实现。\\\\n\\\\n#### 示例：转账方法\\\\n```java\\\\npublic void transfer(String fromAccount, String toAccount, BigDecimal amount) throws SQLException {\\\\n    String sqlDebit = \\\\\\\"UPDATE accounts SET balance = balance - ? WHERE account_no = ? AND balance >= ?\\\\\\\";\\\\n    String sqlCredit = \\\\\\\"UPDATE accounts SET balance = balance + ? WHERE account_no = ?\\\\\\\";\\\\n    \\\\n    try (Connection conn = dataSource.getConnection()) {\\\\n        conn.setAutoCommit(false);\\\\n        try (PreparedStatement debitStmt = conn.prepareStatement(sqlDebit);\\\\n             PreparedStatement creditStmt = conn.prepareStatement(sqlCredit)) {\\\\n            \\\\n            // 扣款\\\\n            debitStmt.setBigDecimal(1, amount);\\\\n            debitStmt.setString(2, fromAccount);\\\\n            debitStmt.setBigDecimal(3, amount);\\\\n            int rows = debitStmt.executeUpdate();\\\\n            if (rows == 0) throw new SQLException(\\\\\\\"账户余额不足或账户不存在\\\\\\\");\\\\n            \\\\n            // 存款\\\\n            creditStmt.setBigDecimal(1, amount);\\\\n            creditStmt.setString(2, toAccount);\\\\n            creditStmt.executeUpdate();\\\\n            \\\\n            conn.commit();\\\\n        } catch (SQLException e) {\\\\n            conn.rollback();\\\\n            throw e;\\\\n        }\\\\n    }\\\\n}\\\\n```\\\\n\\\\n### 4. 连接池：提高性能\\\\n每次操作都创建连接开销大，使用连接池（如HikariCP）复用连接。\\\\n\\\\n#### 配置HikariCP（Maven依赖）\\\\n```xml\\\\n<dependency>\\\\n    <groupId>com.zaxxer</groupId>\\\\n    <artifactId>HikariCP</artifactId>\\\\n    <version>5.0.1</version>\\\\n</dependency>\\\\n```\\\\n\\\\n#### 使用示例\\\\n```java\\\\nHikariConfig config = new HikariConfig();\\\\nconfig.setJdbcUrl(url);\\\\nconfig.setUsername(user);\\\\nconfig.setPassword(password);\\\\nconfig.setMaximumPoolSize(10);\\\\nHikariDataSource dataSource = new HikariDataSource(config);\\\\n\\\\n// 获取连接\\\\ntry (Connection conn = dataSource.getConnection()) {\\\\n    // 操作数据库\\\\n}\\\\n```\\\\n\\\\n### 5. 结合银行系统：DAO模式\\\\n使用DAO（Data Access Object）模式分离数据访问逻辑。\\\\n\\\\n#### AccountDAO接口\\\\n```java\\\\npublic interface AccountDAO {\\\\n    void insert(Account account) throws SQLException;\\\\n    Account findByAccountNo(String accountNo) throws SQLException;\\\\n    void updateBalance(String accountNo, BigDecimal newBalance) throws SQLException;\\\\n    List<Account> findAll() throws SQLException;\\\\n}\\\\n```\\\\n\\\\n#### 实现类AccountDAOImpl\\\\n```java\\\\npublic class AccountDAOImpl implements AccountDAO {\\\\n    private final DataSource dataSource;\\\\n    \\\\n    public AccountDAOImpl(DataSource dataSource) {\\\\n        this.dataSource = dataSource;\\\\n    }\\\\n    \\\\n    @Override\\\\n    public Account findByAccountNo(String accountNo) throws SQLException {\\\\n        String sql = \\\\\\\"SELECT * FROM accounts WHERE account_no = ?\\\\\\\";\\\\n        try (Connection conn = dataSource.getConnection();\\\\n             PreparedStatement pstmt = conn.prepareStatement(sql)) {\\\\n            pstmt.setString(1, accountNo);\\\\n            try (ResultSet rs = pstmt.executeQuery()) {\\\\n                if (rs.next()) {\\\\n                    return new Account(\\\\n                        rs.getInt(\\\\\\\"id\\\\\\\"),\\\\n                        rs.getString(\\\\\\\"account_no\\\\\\\"),\\\\n                        rs.getString(\\\\\\\"holder_name\\\\\\\"),\\\\n                        rs.getBigDecimal(\\\\\\\"balance\\\\\\\")\\\\n                    );\\\\n                }\\\\n                return null;\\\\n            }\\\\n        }\\\\n    }\\\\n    // 其他方法类似...\\\\n}\\\\n```\\\\n\\\\n### 6. 最佳实践\\\\n- **使用PreparedStatement**：防止SQL注入。\\\\n- **使用连接池**：避免频繁创建连接。\\\\n- **事务管理**：确保数据一致性，尤其是转账等操作。\\\\n- **资源关闭**：使用try-with-resources自动关闭Connection、Statement、ResultSet。\\\\n- **异常处理**：捕获SQLException并记录日志。\\\\n\\\\n### 总结\\\\n今天我们学习了JDBC的核心操作，包括连接、增删改查、事务和连接池。结合银行系统，我们实现了账户数据的持久化。下一篇将深入反射与注解，揭示框架的底层原理。\\\\n\\\\n**课后练习**：为银行系统实现一个完整的账户管理模块，包括开户、查询、转账，并使用HikariCP连接池。\\\",\\n    \\\"examples\\\": [\\\"连接MySQL数据库\\\", \\\"插入账户（PreparedStatement）\\\", \\\"转账方法（事务管理）\\\", \\\"HikariCP连接池配置\\\", \\\"AccountDAO接口与实现\\\"],\\n    \\\"coveredTopics\\\": [\\\"JDBC核心步骤\\\", \\\"PreparedStatement\\\", \\\"事务管理（commit/rollback）\\\", \\\"连接池（HikariCP）\\\", \\\"DAO模式\\\"],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调事务一致性和连接池优化。\\\"\\n  },\\n  \\\"updatedOutline\\\": [\\n    \\\"第1篇：异常处理与日志记录——银行系统的稳健之道\\\",\\n    \\\"第2篇：集合框架——从数组到泛型集合的进化\\\",\\n    \\\"第3篇：Java I/O流——文件读写与序列化\\\",\\n    \\\"第4篇：多线程基础——银行系统的并发挑战\\\",\\n    \\\"第5篇：网络编程——Socket通信与RMI\\\",\\n    \\\"第6篇：JDBC与数据库操作——持久化银行数据\\\",\\n    \\\"第7篇：反射与注解——框架的基石\\\",\\n    \\\"第8篇：Lambda表达式与Stream API——函数式编程实战\\\",\\n    \\\"第9篇：设计模式——单例、工厂与观察者\\\",\\n    \\\"第10篇：JVM内存模型与性能调优\\\",\\n    \\\"第11篇：单元测试与Mock——JUnit与Mockito\\\",\\n    \\\"第12篇：构建工具——Maven与Gradle\\\",\\n    \\\"第13篇：版本控制——Git进阶\\\",\\n    \\\"第14篇：Spring基础——依赖注入与AOP\\\",\\n    \\\"第15篇：Spring Boot——快速搭建银行系统\\\",\\n    \\\"第16篇：MyBatis——ORM实战\\\",\\n    \\\"第17篇：RESTful API设计\\\",\\n    \\\"第18篇：微服务入门——Spring Cloud\\\",\\n    \\\"第19篇：Docker容器化部署\\\",\\n    \\\"第20篇：持续集成/持续部署——Jenkins\\\",\\n    \\\"第21篇：消息队列——RabbitMQ与Kafka\\\",\\n    \\\"第22篇：缓存技术——Redis\\\",\\n    \\\"第23篇：搜索引擎——Elasticsearch\\\",\\n    \\\"第24篇：安全机制——认证与授权\\\",\\n    \\\"第25篇：性能测试——JMeter\\\",\\n    \\\"第26篇：日志聚合——ELK Stack\\\",\\n    \\\"第27篇：监控与告警——Prometheus与Grafana\\\",\\n    \\\"第28篇：分布式事务——Seata\\\",\\n    \\\"第29篇：容器编排——Kubernetes\\\",\\n    \\\"第30篇：项目总结——银行系统完整实现\\\"\\n  ],\\n  \\\"updatedState\\\": {\\n    \\\"usedExamples\\\": [\\\"银行账户系统（异常处理）\\\", \\\"文件读取（try-with-resources）\\\", \\\"自定义异常类\\\", \\\"连接MySQL数据库\\\", \\\"插入账户（PreparedStatement）\\\", \\\"转账方法（事务管理）\\\", \\\"HikariCP连接池配置\\\", \\\"AccountDAO接口与实现\\\"],\\n    \\\"coveredTopics\\\": [\\\"异常体系\\\", \\\"try-catch-finally\\\", \\\"多重捕获\\\", \\\"try-with-resources\\\", \\\"自定义异常\\\", \\\"SLF4J与Logback日志\\\", \\\"日志级别\\\", \\\"最佳实践\\\", \\\"JDBC核心步骤\\\", \\\"PreparedStatement\\\", \\\"事务管理（commit/rollback）\\\", \\\"连接池（HikariCP）\\\", \\\"DAO模式\\\"],\\n    \\\"style\\\": \\\"实战驱动，结合银行系统示例，强调事务一致性和连接池优化。\\\"\\n  },\\n  \\\"isSeriesComplete\\\": false\\n}\",\"seriesName\":\"30天Java进阶\"}}', 'FAILED', 1, 8, 200, NULL, NULL, '2026-07-08 19:31:44', '2026-07-08 19:36:33');
