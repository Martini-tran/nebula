...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI 智能体跨实例迭代链（系列递推）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI流程定义表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_flow
-- ----------------------------
INSERT INTO `ai_flow` VALUES (1, 'BLOG_GO', 'go语言学习', '生成go语言学习的文章博客', 1, NULL, 1, '2026-09-19 11:15:02', '2026-09-19 11:15:02', 'DAG', 100, 8, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI流程生成草稿' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ai_flow_draft
-- ----------------------------
INSERT INTO `ai_flow_draft` VALUES (1, 'd_55823f830bab4021b6254bcd2b9f2e3f', 'b23082a9-95e0-4ba9-9747-99bf5f56cfbb', 2052290101098295297, NULL, 'Go 语言学习计划生成流程', '根据学习者的基础水平、目标与每周可投入时间，生成分阶段 Go 语言学习路线图、核心知识点讲解与实战练习建议。', 'DAG', '{\"flowCode\":null,\"name\":\"Go 语言学习计划生成流程\",\"description\":\"根据学习者的基础水平、目标与每周可投入时间，生成分阶段 Go 语言学习路线图、核心知识点讲解与实战练习建议。\",\"version\":1,\"defaultProfileCode\":null,\"engineType\":\"DAG\",\"maxTransitions\":100,\"maxAgentDepth\":8,\"webhookUrl\":null,\"nodes\":[{\"nodeCode\":\"start\",\"name\":\"开始\",\"nodeType\":\"START\",\"systemPrompt\":null,\"promptTemplate\":null,\"profileCode\":null,\"provider\":null,\"model\":null,\"baseUrl\":null,\"apiKey\":null,\"temperature\":null,\"maxTokens\":null,\"topP\":null,\"timeoutMs\":null,\"stop\":[],\"options\":{},\"inputMapping\":{},\"outputKey\":null,\"outputMode\":\"TEXT\",\"nodeConfig\":{\"inputs\":[{\"name\":\"level\",\"type\":\"String\",\"required\":true,\"description\":\"学习者当前编程基础水平\",\"enumValues\":[\"零基础\",\"有其他语言基础\",\"有并发编程经验\"],\"example\":\"有其他语言基础\"},{\"name\":\"goal\",\"type\":\"String\",\"required\":true,\"description\":\"学习 Go 语言的目标，例如后端服务、云原生、CLI 工具\",\"example\":\"后端服务开发\"},{\"name\":\"weeklyHours\",\"type\":\"Number\",\"required\":true,\"description\":\"每周可投入学习的小时数\",\"min\":1,\"max\":60,\"example\":10},{\"name\":\"weeks\",\"type\":\"Number\",\"required\":false,\"description\":\"期望完成学习计划的周数\",\"min\":2,\"max\":52,\"defaultValue\":8},{\"name\":\"resourcesUrl\",\"type\":\"String\",\"required\":false,\"description\":\"用于拉取 Go 学习资源清单的 URL\",\"defaultValue\":\"https://raw.githubusercontent.com/golang/go/master/README.md\",\"example\":\"https://raw.githubusercontent.com/golang/go/master/README.md\"}]},\"rememberTrace\":false,\"stateType\":null,\"sortNo\":0},{\"nodeCode\":\"fetch_resources\",\"name\":\"获取 Go 官方学习资源\",\"nodeType\":\"TOOL\",\"systemPrompt\":null,\"promptTemplate\":null,\"profileCode\":null,\"provider\":null,\"model\":null,\"baseUrl\":null,\"apiKey\":null,\"temperature\":null,\"maxTokens\":null,\"topP\":null,\"timeoutMs\":null,\"stop\":[],\"options\":{},\"inputMapping\":{\"url\":\"resourcesUrl\"},\"outputKey\":\"goResources\",\"outputMode\":\"TEXT\",\"nodeConfig\":{\"toolCode\":\"http\",\"timeoutMs\":15000,\"maxRetries\":1},\"rememberTrace\":false,\"stateType\":null,\"sortNo\":0},{\"nodeCode\":\"end\",\"name\":\"输出学习计划\",\"nodeType\":\"END\",\"systemPrompt\":null,\"promptTemplate\":null,\"profileCode\":null,\"provider\":null,\"model\":null,\"baseUrl\":null,\"apiKey\":null,\"temperature\":null,\"maxTokens\":null,\"topP\":null,\"timeoutMs\":null,\"stop\":[],\"options\":{},\"inputMapping\":{},\"outputKey\":null,\"outputMode\":\"TEXT\",\"nodeConfig\":{\"end\":{\"outputJson\":{\"level\":\"{{level}}\",\"goal\":\"{{goal}}\",\"weeklyHours\":\"{{weeklyHours}}\",\"weeks\":\"{{weeks}}\",\"resources\":\"{{goResources}}\"}}},\"rememberTrace\":false,\"stateType\":null,\"sortNo\":0}],\"edges\":[{\"fromNode\":\"start\",\"toNode\":\"fetch_resources\",\"conditionExpr\":null,\"eventName\":null,\"sortNo\":0},{\"fromNode\":\"fetch_resources\",\"toNode\":\"end\",\"conditionExpr\":null,\"eventName\":null,\"sortNo\":1}]}', 7, NULL, NULL, 'BUILDING', NULL, '2026-09-19 11:15:35', '2026-09-19 11:15:47');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Harness高风险动作确认' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Harness高风险幂等操作' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_relay_package_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_code`(`code` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI中转套餐类型配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_relay_payment_method`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_code`(`code` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI中转支付方式配置' ROW_FORMAT = Dynamic;
...
INSERT INTO `ai_tool` VALUES (20, 'get_harness_operation', '查询 Harness 操作', '按 operationId 查询 PENDING/RUNNING/SUCCEEDED/FAILED/UNKNOWN 状态和安全结果摘要。', 'copilot', '{\"type\": \"object\", \"required\": [\"operationId\"], \"properties\": {\"operationId\": {\"type\": \"string\"}}, \"additionalProperties\": false}', NULL, 1, 1, 115, NULL, '2026-09-19 11:01:39', '2026-09-19 11:01:39');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '编排回调投递记录（日志 + 断点续发）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '博客内容版本表（完整快照）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '博客文件资源表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '博客文章主表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '插件主表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '写作台章节表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of scribe_chapter
-- ----------------------------
INSERT INTO `scribe_chapter` VALUES (1, 4, NULL, '第1章', 2000, 'drafting', NULL, '他推开门。\n\n  雨还在下。', 10, 1, 1, '2026-09-24 15:30:42', 1, '2026-09-24 15:30:43', 1, '2026-09-24 15:30:43');
INSERT INTO `scribe_chapter` VALUES (2, 4, NULL, '夜雨', 3000, 'drafting', NULL, '一二三本地加的断网时写的', 12, 4, 1, '2026-09-24 15:30:42', 1, '2026-09-24 15:40:39', 0, NULL);
INSERT INTO `scribe_chapter` VALUES (3, 4, NULL, '第2章', 4000, 'drafting', NULL, '雨停了。\n\n他在门外站了很久，听见屋里有人说话。又一句。切章前最后一句。', 34, 3, 1, '2026-09-24 15:40:31', 1, '2026-09-24 15:40:34', 0, NULL);
INSERT INTO `scribe_chapter` VALUES (4, 4, NULL, '第三章 灯', 3000, 'drafting', NULL, '正文第一句。', 6, 1, 1, '2026-09-24 15:42:22', 1, '2026-09-24 15:42:26', 1, '2026-09-24 15:42:26');
INSERT INTO `scribe_chapter` VALUES (5, 4, NULL, '第4章', 4000, 'drafting', NULL, '这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。\n\n这是一段用来撑开高度的正文，看看自适应是否生效。', 960, 1, 1, '2026-09-24 15:42:24', 1, '2026-09-24 15:42:26', 1, '2026-09-24 15:42:26');
INSERT INTO `scribe_chapter` VALUES (6, 3, NULL, '第1章', 1000, 'drafting', 'ca', '', 0, 3, 2052290101098295297, '2026-09-24 15:48:49', 2052290101098295297, '2026-09-24 15:49:09', 0, NULL);
INSERT INTO `scribe_chapter` VALUES (7, 3, NULL, '第2章', 2000, 'outline', NULL, '', 0, 0, 2052290101098295297, '2026-09-24 15:49:15', 2052290101098295297, '2026-09-24 15:49:15', 0, NULL);
INSERT INTO `scribe_chapter` VALUES (8, 4, NULL, '第3章', 2000, 'outline', NULL, '', 0, 0, 1, '2026-09-24 16:11:54', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');
INSERT INTO `scribe_chapter` VALUES (9, 4, NULL, '插在卷一', 1000, 'outline', NULL, '', 0, 0, 1, '2026-09-24 16:11:55', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');
INSERT INTO `scribe_chapter` VALUES (10, 4, NULL, '第5章', 5000, 'outline', NULL, '', 0, 0, 1, '2026-09-24 16:17:45', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');
INSERT INTO `scribe_chapter` VALUES (11, 4, NULL, '第6章', 6000, 'outline', NULL, '', 0, 0, 1, '2026-09-24 16:17:46', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');

-- ----------------------------
-- Table structure for scribe_volume
-- ----------------------------
DROP TABLE IF EXISTS `scribe_volume`;
CREATE TABLE `scribe_volume`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '卷ID',
  `work_id` bigint(20) NOT NULL COMMENT '所属作品ID（归属校验走作品的 user_id）',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '卷名',
  `synopsis` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '本卷梗概',
  `sort_order` int(11) NOT NULL DEFAULT 0 COMMENT '排序值，按 1000 间隔稀疏分配',
  `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_by` bigint(20) NULL DEFAULT NULL,
  ...
  `delete_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_scribe_volume_work_sort`(`work_id` ASC, `deleted` ASC, `sort_order` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '写作台卷表（可选的一层，作品无卷时章节平铺）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of scribe_volume
-- ----------------------------
INSERT INTO `scribe_volume` VALUES (1, 4, '第1卷', NULL, 2000, 1, '2026-09-24 16:11:53', 1, '2026-09-24 16:11:56', 1, '2026-09-24 16:11:56');
INSERT INTO `scribe_volume` VALUES (2, 4, '第二卷 · 更漏', NULL, 1000, 1, '2026-09-24 16:11:54', 1, '2026-09-24 16:11:56', 1, '2026-09-24 16:11:56');
INSERT INTO `scribe_volume` VALUES (3, 4, '第一卷 · 雨夜', NULL, 2000, 1, '2026-09-24 16:17:44', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');
INSERT INTO `scribe_volume` VALUES (4, 4, '第二卷 · 更漏', NULL, 1000, 1, '2026-09-24 16:17:44', 1, '2026-09-24 16:17:45', 1, '2026-09-24 16:17:45');
INSERT INTO `scribe_volume` VALUES (5, 4, '第二卷 · 更漏', NULL, 3000, 1, '2026-09-24 16:20:57', 1, '2026-09-24 16:21:29', 1, '2026-09-24 16:21:29');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '写作台作品表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of scribe_work
-- ----------------------------
INSERT INTO `scribe_work` VALUES (3, 2052290101098295297, 'ceshi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'draft', NULL, 0, 2, 2052290101098295297, '2026-09-24 14:18:45', 2052290101098295297, '2026-09-24 15:49:15', 0, NULL);
INSERT INTO `scribe_work` VALUES (4, 1, '章节联调作品', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'draft', NULL, 46, 2, 1, '2026-09-24 15:30:41', 1, '2026-09-24 16:21:29', 0, NULL);
