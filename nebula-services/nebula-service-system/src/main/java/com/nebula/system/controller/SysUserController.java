...
import com.nebula.system.dto.UserResetPasswordRequest;
import com.nebula.system.dto.UserStatusUpdateRequest;
...
/**
 * 系统用户管理（context-path=/system，最终访问路径 /system/user/...）
 *
 * @author nebula
 */
@RestController
