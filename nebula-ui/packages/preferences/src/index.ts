...
} from '@nebula-core/preferences';
import type { DeepPartial } from '@nebula-core/typings';

/**
 * 如果你想所有的app都使用相同的默认偏好设置，你可以在这里定义
 * 而不是去修改 @nebula-core/preferences 中的默认偏好设置
 * @param preferences
 * @returns
 */
...
export * from '@nebula-core/preferences';
