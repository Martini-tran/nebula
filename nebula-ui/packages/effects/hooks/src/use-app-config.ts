import type {
  ApplicationConfig,
  nebulaAdminProAppConfigRaw,
} from '@nebula/types/global';
...
export function useAppConfig(
  ...
  // 生产环境下，直接使用 window._nebula_ADMIN_PRO_APP_CONF_ 全局变量
  const config = isProduction
    ? window._nebula_ADMIN_PRO_APP_CONF_
    : (env as nebulaAdminProAppConfigRaw);
