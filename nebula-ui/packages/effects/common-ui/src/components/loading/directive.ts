...
import { nebulaLoading, nebulaSpinner } from '@nebula-core/shadcn-ui';
import { isString } from '@nebula-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(nebulaLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(nebulaSpinner, getOptions(binding));
    render(instance, el);
