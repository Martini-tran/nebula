...
import { SearchX, X } from '@nebula/icons';
import { $t } from '@nebula/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@nebula/utils';

import { nebulaIcon, nebulaScrollbar } from '@nebula-core/shadcn-ui';
import { isHttpUrl } from '@nebula-core/shared/utils';
  ...
  <nebulaScrollbar>
    <div class="flex! h-full justify-center px-2 sm:max-h-112.5">
      ...
      <ul v-show="searchResults.length > 0" class="w-full">
        ...
        >
          <nebulaIcon :icon="item.icon" class="mr-2 size-5 shrink-0" fallback />
