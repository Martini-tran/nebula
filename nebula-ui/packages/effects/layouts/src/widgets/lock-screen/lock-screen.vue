...
import { LockKeyhole } from '@nebula/icons';
import { $t, useI18n } from '@nebula/locales';
import { storeToRefs, useAccessStore } from '@nebula/stores';

import { useScrollLock } from '@nebula-core/composables';
import { usenebulaForm, z } from '@nebula-core/form-ui';
import { nebulaAvatar, nebulaButton } from '@nebula-core/shadcn-ui';
...
const [Form, { form, validate, getFieldComponentRef }] = usenebulaForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'nebulaInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="mb-10 flex-col-center w-[90%] max-w-75 px-4">
          <nebulaAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <nebulaButton class="enter-x w-full" @click="handleSubmit">
