...
import { Bell, CircleCheckBig, CircleX, MailCheck } from '@nebula/icons';
...
<template>
  <nebulaPopover v-model:open="open" content-class="relative right-2 w-90 p-0">
    <template #trigger>
      <div class="mr-2 flex-center h-full" @click.stop="toggle()">
        <nebulaIconButton class="bell-button relative text-foreground">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <nebulaScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <nebulaButton size="sm" @click="handleViewAll">
