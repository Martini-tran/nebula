...
import type { TabDefinition } from '@nebula/types';

import type { IContextMenuItem } from '@nebula-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@nebula/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@nebula/stores';
import { filterTree } from '@nebula/utils';
