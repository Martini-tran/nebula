...
import { RotateCw } from '@nebula/icons';
import { preferences, usePreferences } from '@nebula/preferences';
import { useAccessStore } from '@nebula/stores';

import { nebulaFullScreen, nebulaIconButton } from '@nebula-core/shadcn-ui';
  ...
  >
    <slot :name="slot.name">
      <template v-if="slot.name === 'refresh'">
        <nebulaIconButton class="my-0 mr-1 rounded-md" @click="refresh">
