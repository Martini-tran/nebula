...
import { useForwardPropsEmits } from '@nebula-core/composables';
import { ChevronsLeft, ChevronsRight } from '@nebula-core/icons';
import { nebulaScrollbar } from '@nebula-core/shadcn-ui';
