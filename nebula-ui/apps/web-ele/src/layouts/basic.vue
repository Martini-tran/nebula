...
import { AuthenticationLoginExpiredModal } from '@nebula/common-ui';
import { nebula_DOC_URL, nebula_GITHUB_URL } from '@nebula/constants';
...
const menus = computed(() => [
  ...
  {
    handler: () => {
      openWindow(`${nebula_GITHUB_URL}/issues`, {
        target: '_blank',
      });
    },
    icon: CircleHelp,
