...
import type { CustomPreferencesRecord } from '@nebula/preferences';
import type {
  BreadcrumbStyleType,
  BuiltinThemeType,
  ContentCompactType,
...
import type { SegmentedItem } from '@nebula-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, Pin, PinOff, RotateCw } from '@nebula/icons';
