...
import type { ClassType, DeepPartial } from '@nebula/types';

import type { BaseFormComponentType, nebulaFormProps } from '@nebula-core/form-ui';
...
> {
   ...
   * 表单配置
   */
  formOptions?: nebulaFormProps<D, P>;
  /**
   * 显示搜索表单
   */
...
export interface SetupVxeTable {
  ...
  usenebulaForm?: typeof usenebulaForm;
}
