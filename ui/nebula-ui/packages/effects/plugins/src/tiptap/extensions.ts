...
import type { ImageUploadOptions, nebulaTiptapExtensionOptions } from './types';

import { $t } from '@nebula/locales';

import { alert } from '@nebula-core/popup-ui';
  ...
  return Image.extend({
    ...
    addNodeView() {
      return ({ node }) => {
        ...
        wrapper.className = 'nebula-tiptap-upload-wrapper';

        const img = document.createElement('img');
        img.src = node.attrs.src;
        img.className = 'nebula-tiptap__image';
        wrapper.append(img);

        const spinner = document.createElement('div');
        spinner.className = 'nebula-tiptap-upload-spinner';
        wrapper.append(spinner);

        const progressBar = document.createElement('div');
        progressBar.className = 'nebula-tiptap-upload-progress';
        const progressFill = document.createElement('div');
        progressFill.className = 'nebula-tiptap-upload-progress-fill';
...
export function createDefaultTiptapExtensions(
  options: nebulaTiptapExtensionOptions = {},
): Extensions {
  return [
    Document,
