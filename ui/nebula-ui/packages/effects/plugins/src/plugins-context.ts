import type { nebulaPluginsOptions } from './types';

let globalPluginsOptions: null | nebulaPluginsOptions = null;

export function providePluginsOptions(options: nebulaPluginsOptions) {
