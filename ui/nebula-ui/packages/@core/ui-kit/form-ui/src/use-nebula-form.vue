...
import type { ExtendedFormApi, nebulaFormProps } from './types';

// import { toRaw, watch } from 'vue';
import { nextTick, onMounted, watch } from 'vue';

import { useForwardPriorityValues } from '@nebula-core/composables';
import { cloneDeep, get, isEqual, set } from '@nebula-core/shared/utils';
...
interface Props extends nebulaFormProps {
    ...
    <template #default="slotProps">
      <slot v-bind="slotProps">
        <FormActions
          ...
          :can-collapse="slotProps.canCollapse"
