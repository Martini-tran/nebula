...
import { ChevronsDown, CircleAlert } from '@nebula-core/icons';
import {
  Button,
  FormControl,
  FormDescription,
...
import { cn, isFunction, isObject, isString } from '@nebula-core/shared/utils';
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <template v-if="label">
          <nebulaRenderContent :content="label" />
        </template>
        <template #extra>
          <Button
            class="ml-0.5"
      ...
      <div class="flex-auto overflow-hidden p-px">
        <nebulaCollapsible :show-trigger="false" v-model:open="collapseOpen">
          <template #collapsibleContent>
            <div :class="cn('relative flex w-full items-center', wrapperClass)">
              ...
              <div v-if="suffix" class="ml-1">
                <nebulaRenderContent :content="suffix" />
              </div>
            </div>
          </template>
        </nebulaCollapsible>
        ...
        <FormDescription v-if="description" class="text-xs">
          <nebulaRenderContent :content="description" />
        </FormDescription>
