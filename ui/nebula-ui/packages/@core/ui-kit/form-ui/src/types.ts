...
import type { nebulaButtonProps } from '@nebula-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@nebula-core/typings';
...
export interface ActionButtonOptions extends nebulaButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface nebulaFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
  P extends Record<string, any> = Record<never, never>,
> extends Omit<
  FormRenderProps<T, P>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<nebulaFormProps>>(
    selector?: (state: NoInfer<nebulaFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface nebulaFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
