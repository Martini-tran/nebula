...
import type { ExtendedFormApi, FormActions, nebulaFormProps } from './types';

import { computed, unref, useSlots } from 'vue';

import { createContext } from '@nebula-core/shadcn-ui';
import { isString, mergeWithArrayOverride, set } from '@nebula-core/shared/utils';

import { useForm } from 'vee-validate';
import { object, ZodIntersection, ZodNumber, ZodObject, ZodString } from 'zod';
import { getDefaultsForSchema } from 'zod-defaults';

type ExtendFormProps = nebulaFormProps & { formApi?: ExtendedFormApi };
...
export function useFormInitial(
  props: ComputedRef<nebulaFormProps> | nebulaFormProps,
) {
