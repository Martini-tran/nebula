...
import type { Recordable } from '@nebula-core/typings';
...
import { Input, nebulaRenderContent } from '@nebula-core/shadcn-ui';
import { isFunction, isString } from '@nebula-core/shared/utils';
...
export function nebulaAlert(options: AlertProps): Promise<void>;
export function nebulaAlert(
  message: string,
...
export function nebulaConfirm(options: AlertProps): Promise<void>;
export function nebulaConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function nebulaConfirm(
...
export function nebulaConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? nebulaAlert(arg0, defaultProps)
      : nebulaAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? nebulaAlert(arg0 as string, arg1, defaultProps)
      : nebulaAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return nebulaAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function nebulaPrompt<T = any>(
  ...
  const staticContents: Component[] = [
    h(nebulaRenderContent, { content, renderBr: true }),
  ];
