...
import type { TabDefinition } from '@nebula-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@nebula-core/icons';
import { nebulaContextMenu, nebulaIcon } from '@nebula-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
  name: 'nebulaTabsChrome',
  inheritAttrs: false,
});

const props = withDefaults(defineProps<Props>(), {
  contentClass: 'nebula-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
