...
import { nebulaIcon, nebulaTooltip } from '@nebula-core/shadcn-ui';
    ...
    >
      ...
      >
        <template #trigger>
          <div :class="[nsMenu.be('tooltip', 'trigger')]">
            <nebulaIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
            <slot></slot>
      ...
      <div v-show="!showTooltip" :class="[e('content')]">
        <MenuBadge
          ...
          v-bind="props"
        />
        <nebulaIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
        <slot></slot>
        <slot name="title"></slot>
      </div>
    </a>
