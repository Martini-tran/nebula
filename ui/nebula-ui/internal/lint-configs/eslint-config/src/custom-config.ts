...
const customConfig: Linter.Config[] = [
          ...
          patterns: [
            {
              group: ['@nebula/*'],
              message:
                'The @core package cannot import the @nebula package, please use the @core package itself',
            },
          ],
        },
      ],
  ...
  {
    // @core/shared内部组件，不能引入@nebula/* 或者 @nebula-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@nebula/*', '@nebula-core/*'],
              message:
                'The @nebula-core/shared package cannot import the @nebula package, please use the @core/shared package itself',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@nebula/*'],
              message:
                'The @nebula package cannot be imported, please use the @core package itself',
            },
          ],
        },
      ],
